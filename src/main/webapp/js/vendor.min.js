...
function(e, t) {
    ...
    function y(e, t, n) {
        var r, s = (t = t || i).createElement("script");
    ...
    w.extend = w.fn.extend = function() {
        ...
        l = arguments.length,
        c = !1;
        for ("boolean" == typeof o && (c = o, o = arguments[a] || {},
        a++), "object" == typeof o || m(o) || (o = {}), a === l && (o = this, a--); a < l; a++) if (null != (e = arguments[a])) for (t in e) n = o[t],
        o !== (i = e[t]) && (c && i && (w.isPlainObject(i) || (r = Array.isArray(i))) ? (r ? (r = !1, s = n && Array.isArray(n) ? n: []) : s = n && w.isPlainObject(n) ? n: {},
        o[t] = w.extend(c, s, i)) : void 0 !== i && (o[t] = i));
        return o
    },
    w.extend({
    ...
    var x = function(e) {
        var t, n, i, r, s, o, a, l, c, u, h, d, f, p, m, g, v, y, _, b = "sizzle" + 1 * new Date,
        w = e.document,
        D = 0,
        C = 0,
        x = oe(),
        ...
        function se(e, t, i, r) {
            var s, a, c, u, h, p, v, y = t && t.ownerDocument,
            D = t ? t.nodeType: 9;
            if (i = i || [], "string" != typeof e || !e || 1 !== D && 9 !== D && 11 !== D) return i;
            if (!r && ((t ? t.ownerDocument || t: w) !== f && d(t), t = t || f, m)) {
                if (11 !== D && (h = Z.exec(e))) if (s = h[1]) {
                    if (9 === D) {
                        if (! (c = t.getElementById(s))) return i;
                        if (c.id === s) return i.push(c),
                        i
                    } else if (y && (c = y.getElementById(s)) && _(t, c) && c.id === s) return i.push(c),
                    i
                } else {
                    if (h[2]) return I.apply(i, t.getElementsByTagName(e)),
                    i;
                    if ((s = h[3]) && n.getElementsByClassName && t.getElementsByClassName) return I.apply(i, t.getElementsByClassName(s)),
                    i
                }
                if (n.qsa && !S[e + " "] && (!g || !g.test(e))) {
                    ...
                    v = e;
                        ...
                        for ((u = t.getAttribute("id")) ? u = u.replace(te, ne) : t.setAttribute("id", u = b), a = (p = o(e)).length; a--;) p[a] = "#" + u + " " + ve(p[a]);
                        v = p.join(","),
        ...
        d = se.setDocument = function(e) {
            ...
            return o !== f && 9 === o.nodeType && o.documentElement ? (p = (f = o).documentElement, m = !s(f), w !== f && (r = f.defaultView) && r.top !== r && (r.addEventListener ? r.addEventListener("unload", ie, !1) : r.attachEvent && r.attachEvent("onunload", ie)), n.attributes = le(function(e) {
            ...
            v = [], g = [], (n.qsa = Q.test(f.querySelectorAll)) && (le(function(e) {
                ...
                e.querySelectorAll("[selected]").length || g.push("\\[" + Y + "*(?:value|" + L + ")"),
                ...
                y.call(e, "[s!='']:x"),
                v.push("!=", $)
            }), g = g.length && new RegExp(g.join("|")), v = v.length && new RegExp(v.join("|")), t = Q.test(p.compareDocumentPosition), _ = t || Q.test(p.contains) ?
            function(e, t) {
            ...
            function(e, t) {
                ...
                o = [e],
                a = [t];
                if (!r || !s) return e === f ? -1 : t === f ? 1 : r ? -1 : s ? 1 : u ? P(u, e) - P(u, t) : 0;
                if (r === s) return ue(e, t);
                for (n = e; n = n.parentNode;) o.unshift(n);
                for (n = t; n = n.parentNode;) a.unshift(n);
                for (; o[i] === a[i];) i++;
                return i ? ue(o[i], a[i]) : o[i] === w ? -1 : a[i] === w ? 1 : 0
            },
            f) : f
        },
        ...
        se.attr = function(e, t) { (e.ownerDocument || e) !== f && d(e);
            var r = i.attrHandle[t.toLowerCase()],
            s = r && E.call(i.attrHandle, t.toLowerCase()) ? r(e, t, !m) : void 0;
        ...
        (i = se.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t, n = !e[6] && e[2];
                    return G.CHILD.test(e[0]) ? null: (e[3] ? e[2] = e[4] || e[5] || "": n && B.test(n) && (t = o(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t), e[2] = n.slice(0, t)), e.slice(0, 3))
                }
            },
            filter: {
                TAG: function(e) {
                ...
                CLASS: function(e) {
                    var t = x[e + " "];
                    return t || (t = new RegExp("(^|" + Y + ")" + e + "(" + Y + "|$)")) && x(e,
                    function(e) {
                ...
                PSEUDO: function(e, t) {
                    ...
                    return r[b] ? r(t) : r.length > 1 ? (n = [e, e, "", t], i.setFilters.hasOwnProperty(e.toLowerCase()) ? ae(function(e, n) {
                        for (var i, s = r(e, t), o = s.length; o--;) e[i = P(e, s[o])] = !(n[i] = s[o])
                    }) : function(e) {
                        return r(e, 0, n)
                    }) : r
                }
        ...
        function ye(e, t, n) {
            ...
            function(t, n, r) {
                ...
                } else for (; t = t[i];) if (1 === t.nodeType || o) if (u = (h = t[b] || (t[b] = {}))[t.uniqueID] || (h[t.uniqueID] = {}), r && r === t.nodeName.toLowerCase()) t = t[i] || t;
                else {
                    if ((c = u[s]) && c[0] === D && c[1] === a) return d[2] = c[2];
            ...
            ae(function(s, o, a, l) {
                ...
                if (s) {
                    if (r || e) {
                        ...
                        for (u = v.length; u--;)(h = v[u]) && (c = r ? P(s, h) : d[u]) > -1 && (s[c] = !(o[c] = h))
                    }
                } else v = be(v === o ? v.splice(p, v.length) : v),
                r ? r(null, o, v, l) : I.apply(o, v)
            })
        }
        function De(e) {
            for (var t, n, r, s = e.length,
            o = i.relative[e[0].type], a = o || i.relative[" "], l = o ? 1 : 0, u = ye(function(e) {
                return e === t
            },
            a, !0), h = ye(function(e) {
                return P(t, e) > -1
            ...
            a, !0), d = [function(e, n, i) {
                ...
                return t = null,
                r
            }]; l < s; l++) if (n = i.relative[e[l].type]) d = [ye(_e(d), n)];
            else {
                if ((n = i.filter[e[l].type].apply(null, e[l].matches))[b]) {
                    for (r = ++l; r < s && !i.relative[e[r].type]; r++);
                    return we(l > 1 && _e(d), l > 1 && ve(e.slice(0, l - 1).concat({
                        value: " " === e[l - 2].type ? "*": ""
                    })).replace(W, "$1"), n, l < r && De(e.slice(l, r)), r < s && De(e = e.slice(r)), r < s && ve(e))
                }
                d.push(n)
            }
            return _e(d)
        ...
        o = se.tokenize = function(e, t) {
            ...
            for (a = e, l = [], c = i.preFilter; a;) {
                for (o in n && !(r = q.exec(a)) || (r && (a = a.slice(r[0].length) || a), l.push(s = [])), n = !1, (r = F.exec(a)) && (n = r.shift(), s.push({
                    value: n,
                    type: r[0].replace(W, " ")
                }), a = a.slice(n.length)), i.filter) ! (r = G[o].exec(a)) || c[o] && !(r = c[o](r)) || (n = r.shift(), s.push({
                    value: n,
                    type: o,
                    matches: r
                }), a = a.slice(n.length));
        ...
        a = se.compile = function(e, t) {
            ...
            g = S[e + " "];
            if (!g) {
                for (t || (t = o(e)), n = t.length; n--;)(g = De(t[n]))[b] ? h.push(g) : p.push(g); (g = S(e, (r = p, a = (s = h).length > 0, l = r.length > 0, u = function(e, t, n, o, u) {
                    var h, p, g, v = 0,
                    y = "0",
                    _ = e && [],
                    b = [],
                    ...
                    if (v += y, a && y !== v) {
                        ...
                        if (e) {
                            if (v > 0) for (; y--;) _[y] || b[y] || (b[y] = O.call(o));
                            b = be(b)
                        }
                        I.apply(o, b),
                        u && !e && b.length > 0 && v + s.length > 1 && se.uniqueSort(o)
                    }
                    return u && (D = x, c = w),
                    _
                },
        ...
        l = se.select = function(e, t, n, r) {
            var s, l, c, u, h, d = "function" == typeof e && e,
            ...
            if (n = n || [], 1 === f.length) {
                ...
                for (s = G.needsContext.test(e) ? 0 : l.length; s--&&(c = l[s], !i.relative[u = c.type]);) if ((h = i.find[u]) && (r = h(c.matches[0].replace(J, ee), X.test(l[0].type) && me(t.parentNode) || t))) {
                    if (l.splice(s, 1), !(e = r.length && ve(l))) return I.apply(n, r),
                    n;
                    break
                }
            }
            return (d || a(e, f))(r, t, !m, n, !t || X.test(e) && me(t.parentNode) || t),
            n
        },
    ...
    w.filter = function(e, t, n) {
        var i = t[0];
        return n && (e = ":not(" + e + ")"),
        1 === t.length && 1 === i.nodeType ? w.find.matchesSelector(i, e) ? [i] : [] : w.find.matches(e, w.grep(t,
        function(e) {
            return 1 === e.nodeType
        }))
    },
    ...
    var M, I = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/; (w.fn.init = function(e, t, n) {
        var r, s;
        if (!e) return this;
        if (n = n || M, "string" == typeof e) {
            ...
            return (s = i.getElementById(r[2])) && (this[0] = s, this.length = 1),
            this
        }
    ...
    w.fn.extend({
        ...
        closest: function(e, t) {
            ...
            if (!T.test(e)) for (; i < r; i++) for (n = this[i]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (o ? o.index(n) > -1 : 1 === n.nodeType && w.find.matchesSelector(n, e))) {
                s.push(n);
                break
            }
    ...
    function(e, t) {
        w.fn[e] = function(n, i) {
            ...
            this.length > 1 && (P[e] || w.uniqueSort(r), N.test(e) && r.reverse()),
            this.pushStack(r)
        }
    });
    var Y = /[^\x20\t\r\n\f]+/g;
    ...
    w.Callbacks = function(e) {
        ...
        h = {
            add: function() {
                return a && (r && !i && (c = a.length - 1, l.push(r)),
                function t(n) {
                    w.each(n,
                    function(n, i) {
            ...
            remove: function() {
                ...
                function(e, t) {
                    for (var n; (n = w.inArray(t, a, n)) > -1;) a.splice(n, 1),
                    n <= c && c--
                }),
                this
            },
    ...
    w.extend({
            ...
            r = {
                ...
                then: function(t, i, r) {
                        ...
                        return function() {
                            ...
                            c = function() {
                                ...
                                if (! (t < s)) {
                                    ...
                                    m(c) ? r ? c.call(e, o(s, n, j, r), o(s, n, H, r)) : (s++, c.call(e, o(s, n, j, r), o(s, n, H, r), o(s, n, j, n.notifyWith))) : (i !== j && (a = void 0, l = [e]), (r || n.resolveWith)(a, l))
                                }
                            },
                            u = r ? c: function() {
                                try {
                                    ...
                                    t + 1 >= s && (i !== H && (a = void 0, l = [e]), n.rejectWith(a, l))
                                }
                            };
                    ...
                    return w.Deferred(function(e) {
                        n[0][3].add(o(0, e, m(r) ? r: j, e.notifyWith)),
        ...
        when: function(e) {
            ...
            if (t <= 1 && ($(e, o.done(a(n)).resolve, o.reject, !t), "pending" === o.state() || m(r[n] && r[n].then))) return o.then();
    ...
    w.extend({
        isReady: !1,
        readyWait: 1,
        ready: function(e) { (!0 === e ? --w.readyWait: w.isReady) || (w.isReady = !0, !0 !== e && --w.readyWait > 0 || W.resolveWith(i, [w]))
        }
    }),
    w.ready.then = W.then,
    ...
    var F = function(e, t, n, i, r, s, o) {
        ...
        l = e.length,
        c = null == n;
        if ("object" === _(n)) for (a in r = !0, n) F(e, t, a, n[a], !0, s, o);
        else if (void 0 !== i && (r = !0, m(i) || (o = !0), c && (o ? (t.call(e, i), t = null) : (c = t, t = function(e, t, n) {
            return c.call(w(e), n)
    ...
    K.prototype = {
        ...
        remove: function(e, t) {
            ...
            if (void 0 !== i) {
                if (void 0 !== t) {
                    n = (t = Array.isArray(t) ? t.map(G) : (t = G(t)) in i ? [t] : t.match(Y) || []).length;
                    for (; n--;) delete i[t[n]]
        ...
        data: function(e, t) {
            ...
            if (void 0 === e) {
                if (this.length && (r = Z.get(s), 1 === s.nodeType && !Q.get(s, "hasDataAttrs"))) {
                    for (n = o.length; n--;) o[n] && 0 === (i = o[n].name).indexOf("data-") && (i = G(i.slice(5)), ee(s, i, r[i]));
            ...
            function(t) {
                var n;
                if (s && void 0 === t) return void 0 !== (n = Z.get(s, e)) ? n: void 0 !== (n = ee(s, e)) ? n: void 0;
                this.each(function() {
                    Z.set(this, e, t)
                })
            },
    ...
    w.extend({
        ...
        dequeue: function(e, t) {
            ...
            r && ("fx" === t && n.unshift("inprogress"), delete s.stop, r.call(e,
            function() {
                w.dequeue(e, t)
            },
            s)),
    ...
    function oe(e, t, n, i) {
        ...
        if (u && u[3] !== c) {
            for (l /= 2, c = c || u[3], u = +l || 1; o--;) w.style(e, t, u + c),
            (1 - s) * (1 - (s = a() / l || .5)) <= 0 && (o = 0),
            u /= s;
            u *= 2,
            w.style(e, t, u + c),
    ...
    function pe(e, t) {
        for (var n = 0,
        i = e.length; n < i; n++) Q.set(e[n], "globalEval", !t || Q.get(t[n], "globalEval"))
    }
    ...
    function ye(e, t, n, i, r) {
        for (var s, o, a, l, c, u, h = t.createDocumentFragment(), d = [], f = 0, p = e.length; f < p; f++) if ((s = e[f]) || 0 === s) if ("object" === _(s)) w.merge(d, s.nodeType ? [s] : s);
        else if (ve.test(s)) {
            for (o = o || h.appendChild(t.createElement("div")), a = (ue.exec(s) || ["", ""])[1].toLowerCase(), l = de[a] || de._default, o.innerHTML = l[1] + w.htmlPrefilter(s) + l[2], u = l[0]; u--;) o = o.lastChild;
            w.merge(d, o.childNodes),
            (o = h.firstChild).textContent = ""
        } else d.push(t.createTextNode(s));
        for (h.textContent = "", f = 0; s = d[f++];) if (i && w.inArray(s, i) > -1) r && r.push(s);
        else if (c = w.contains(s.ownerDocument, s), o = fe(h.appendChild(s), "script"), c && pe(o), n) for (u = 0; s = o[u++];) he.test(s.type || "") && n.push(s);
        return h
    }
    ...
    w.event = {
        ...
        add: function(e, t, n, i, r) {
            var s, o, a, l, c, u, h, d, f, p, m, g = Q.get(e);
            if (g) for (n.handler && (n = (s = n).handler, r = s.selector), r && w.find.matchesSelector(_e, r), n.guid || (n.guid = w.guid++), (l = g.events) || (l = g.events = {}), (o = g.handle) || (o = g.handle = function(t) {
                return void 0 !== w && w.event.triggered !== t.type ? w.event.dispatch.apply(e, arguments) : void 0
            }), c = (t = (t || "").match(Y) || [""]).length; c--;) f = m = (a = De.exec(t[c]) || [])[1],
            p = (a[2] || "").split(".").sort(),
            f && (h = w.event.special[f] || {},
            f = (r ? h.delegateType: h.bindType) || f, h = w.event.special[f] || {},
            u = w.extend({
                type: f,
                origType: m,
                data: i,
            ...
            s), (d = l[f]) || ((d = l[f] = []).delegateCount = 0, h.setup && !1 !== h.setup.call(e, i, p, o) || e.addEventListener && e.addEventListener(f, o)), h.add && (h.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), r ? d.splice(d.delegateCount++, 0, u) : d.push(u), w.event.global[f] = !0)
        },
        remove: function(e, t, n, i, r) {
            var s, o, a, l, c, u, h, d, f, p, m, g = Q.hasData(e) && Q.get(e);
            if (g && (l = g.events)) {
                for (c = (t = (t || "").match(Y) || [""]).length; c--;) if (f = m = (a = De.exec(t[c]) || [])[1], p = (a[2] || "").split(".").sort(), f) {
                    for (h = w.event.special[f] || {},
                    d = l[f = (i ? h.delegateType: h.bindType) || f] || [], a = a[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), o = s = d.length; s--;) u = d[s],
                    !r && m !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (d.splice(s, 1), u.selector && d.delegateCount--, h.remove && h.remove.call(e, u));
                    o && !d.length && (h.teardown && !1 !== h.teardown.call(e, p, g.handle) || w.removeEvent(e, f, g.handle), delete l[f])
                } else for (f in l) w.event.remove(e, f + t[c], n, i, !0);
                w.isEmptyObject(l) && Q.remove(e, "handle events")
            }
        },
        dispatch: function(e) {
            var t, n, i, r, s, o, a = w.event.fix(e),
        ...
        handlers: function(e, t) {
            ...
            if (l && c.nodeType && !("click" === e.type && e.button >= 1)) for (; c !== this; c = c.parentNode || this) if (1 === c.nodeType && ("click" !== e.type || !0 !== c.disabled)) {
                for (s = [], o = {},
                n = 0; n < l; n++) void 0 === o[r = (i = t[n]).selector + " "] && (o[r] = i.needsContext ? w(r, this).index(c) > -1 : w.find(r, this, null, [c]).length),
                o[r] && s.push(i);
                s.length && a.push({
                    elem: c,
                    handlers: s
    ...
    w.Event = function(e, t) {
        ...
        e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? Ce: xe, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode: e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e,
        t && w.extend(this, t),
    ...
    function Pe(e, t) {
        var n, i, r, s, o, a, l, c;
        if (1 === t.nodeType) {
            if (Q.hasData(e) && (s = Q.access(e), o = Q.set(t, s), c = s.events)) for (r in delete o.handle, o.events = {},
            c) for (n = 0, i = c[r].length; n < i; n++) w.event.add(t, r, c[r][n]);
            Z.hasData(e) && (a = Z.access(e), l = w.extend({},
            a), Z.set(t, l))
        }
    }
    function Le(e, t, n, i) {
        ...
        if (d && (s = (r = ye(t, e[0].ownerDocument, !1, e, i)).firstChild, 1 === r.childNodes.length && (r = s), s || i)) {
            for (l = (a = w.map(fe(r, "script"), Ie)).length; h < d; h++) c = r,
            h !== f && (c = w.clone(c, !0, !0), l && w.merge(a, fe(c, "script"))),
            n.call(e[h], c, h);
            if (l) for (u = a[a.length - 1].ownerDocument, w.map(a, Ne), h = 0; h < l; h++) c = a[h],
            he.test(c.type || "") && !Q.access(c, "globalEval") && w.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? w._evalUrl && w._evalUrl(c.src) : y(c.textContent.replace(Oe, ""), u, c))
        }
        return e
    }
    function Ye(e, t, n) {
        for (var i, r = t ? w.filter(t, e) : e, s = 0; null != (i = r[s]); s++) n || 1 !== i.nodeType || w.cleanData(fe(i)),
        i.parentNode && (n && w.contains(i.ownerDocument, i) && pe(fe(i, "script")), i.parentNode.removeChild(i));
        return e
    }
    w.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (! (p.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || w.isXMLDoc(e))) for (o = fe(u), i = 0, r = (s = fe(e)).length; i < r; i++) a = s[i],
            l = o[i],
            void 0,
            "input" === (c = l.nodeName.toLowerCase()) && ce.test(a.type) ? l.checked = a.checked: "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
            if (t) if (n) for (s = s || fe(e), o = o || fe(u), i = 0, r = s.length; i < r; i++) Pe(s[i], o[i]);
            else Pe(e, u);
            return (o = fe(u, "script")).length > 0 && pe(o, !h && fe(e, "script")),
            u
        },
        cleanData: function(e) {
            for (var t, n, i, r = w.event.special,
            s = 0; void 0 !== (n = e[s]); s++) if (z(n)) {
                if (t = n[Q.expando]) {
    ...
    function(e, t) {
        w.fn[e] = function(e) {
            for (var n, i = [], r = w(e), s = r.length - 1, o = 0; o <= s; o++) n = o === s ? this: this.clone(!0),
            w(r[o])[t](n),
            a.apply(i, n.get());
    ...
    function Re(e, t, n) {
        ...
        return (n = n || He(e)) && ("" !== (o = n.getPropertyValue(t) || n[t]) || w.contains(e.ownerDocument, e) || (o = w.style(e, t)), !p.pixelBoxStyles() && je.test(o) && $e.test(t) && (i = a.width, r = a.minWidth, s = a.maxWidth, a.minWidth = a.maxWidth = a.width = o, o = n.width, a.width = i, a.minWidth = r, a.maxWidth = s)),
        void 0 !== o ? o + "": o
    }
    function We(e, t) {
        return {
    ...
    function Qe(e, t, n, i, r, s) {
        ...
        for (; o < 4; o += 2)"margin" === n && (l += w.css(e, n + ie[o], !0, r)),
        i ? ("content" === n && (l -= w.css(e, "padding" + ie[o], !0, r)), "margin" !== n && (l -= w.css(e, "border" + ie[o] + "Width", !0, r))) : (l += w.css(e, "padding" + ie[o], !0, r), "padding" !== n ? l += w.css(e, "border" + ie[o] + "Width", !0, r) : a += w.css(e, "border" + ie[o] + "Width", !0, r));
        return ! i && s >= 0 && (l += Math.max(0, Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - s - l - a - .5))),
        l
    }
    function Ze(e, t, n) {
        var i = He(e),
        ...
        return o = o && (p.boxSizingReliable() || r === e.style[t]),
        ("auto" === r || !parseFloat(r) && "inline" === w.css(e, "display", !1, i)) && (r = e["offset" + t[0].toUpperCase() + t.slice(1)], o = !0),
    ...
    w.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                l = Fe.test(t),
                c = e.style;
                if (l || (t = ze(a)), o = w.cssHooks[t] || w.cssHooks[a], void 0 === n) return o && "get" in o && void 0 !== (r = o.get(e, !1, i)) ? r: c[t];
                "string" === (s = typeof n) && (r = ne.exec(n)) && r[1] && (n = oe(e, t, r), s = "number"),
                null != n && n == n && ("number" === s && (n += r && r[3] || (w.cssNumber[a] ? "": "px")), p.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), o && "set" in o && void 0 === (n = o.set(e, n, i)) || (l ? c.setProperty(t, n) : c[t] = n))
            }
        },
    ...
    function(e, t) {
        w.cssHooks[t] = {
            get: function(e, n, i) {
                if (n) return ! qe.test(w.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Ze(e, t, i) : se(e, Ue,
                function() {
                    return Ze(e, t, i)
                })
            },
            set: function(e, n, i) {
                ...
                a = i && Qe(e, t, i, o, s);
                return o && p.scrollboxSize() === s.position && (a -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(s[t]) - Qe(e, t, "border", !1, s) - .5)),
                a && (r = ne.exec(n)) && "px" !== (r[3] || "px") && (e.style[t] = n, n = w.css(e, t)),
                Ke(0, n, a)
            }
        }
    }),
    w.cssHooks.marginLeft = We(p.reliableMarginLeft,
    function(e, t) {
    ...
    function(e, t) {
        w.cssHooks[e + t] = {
            expand: function(n) {
                for (var i = 0,
                r = {},
                s = "string" == typeof n ? n.split(" ") : [n]; i < 4; i++) r[e + ie[i] + t] = s[i] || s[i - 2] || s[0];
                return r
            }
        },
    ...
    w.fn.extend({
        css: function(e, t) {
            ...
            function(e, t, n) {
                ...
                o = 0;
                if (Array.isArray(t)) {
                    for (i = He(e), r = t.length; o < r; o++) s[t[o]] = w.css(e, t[o], !1, i);
                    return s
                }
    ...
    rt = /queueHooks$/;
    function st() {
        et && (!1 === i.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(st) : e.setTimeout(st, w.fx.interval), w.fx.tick())
    }
    function ot() {
    ...
    function ct(e, t, n) {
        ...
        l = function() {
            ...
            i < 1 && o ? n: (o || a.notifyWith(e, [c, 1, 0]), a.resolveWith(e, [c]), !1)
        },
        c = a.promise({
            elem: e,
            props: w.extend({},
        ...
        function(e, t) {
            var n, i, r, s, o;
            for (n in e) if (r = t[i = G(n)], s = e[n], Array.isArray(s) && (r = s[1], s = e[n] = s[0]), n !== i && (e[i] = s, delete e[n]), (o = w.cssHooks[i]) && "expand" in o) for (n in s = o.expand(s), delete e[i], s) n in e || (e[n] = s[n], t[n] = r);
            else t[i] = r
        } (u, c.opts.specialEasing); s < o; s++) if (i = ct.prefilters[s].call(c, e, u, c.opts)) return m(i.stop) && (w._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)),
        i;
        return w.map(u, lt, c),
    ...
    w.Animation = w.extend(ct, {
        ...
        prefilters: [function(e, t, n) {
            ...
            m = e.nodeType && re(e),
            g = Q.get(e, "fxshow");
            for (i in n.queue || (null == (o = w._queueHooks(e, "fx")).unqueued && (o.unqueued = 0, a = o.empty.fire, o.empty.fire = function() {
                o.unqueued || a()
    ...
    w.speed = function(e, t, n) {
        var i = e && "object" == typeof e ? w.extend({},
        e) : {
    ...
    w.fn.extend({
        ...
        animate: function(e, t, n, i) {
            ...
            o = function() {
                ...
                e), s); (r || Q.get(this, "finish")) && t.stop(!0)
            };
            return o.finish = o,
        ...
        stop: function(e, t, n) {
            ...
            this.each(function() {
                ...
                for (r = s.length; r--;) s[r].elem !== this || null != e && s[r].queue !== e || (s[r].anim.stop(n), t = !1, s.splice(r, 1)); ! t && n || w.dequeue(this, e)
            })
        },
        finish: function(e) {
            return ! 1 !== e && (e = e || "fx"),
    ...
    w.extend({
        attr: function(e, t, n) {
            ...
            if (3 !== s && 8 !== s && 2 !== s) return void 0 === e.getAttribute ? w.prop(e, t, n) : (1 === s && w.isXMLDoc(e) || (r = w.attrHooks[t.toLowerCase()] || (w.expr.match.bool.test(t) ? ut: void 0)), void 0 !== n ? null === n ? void w.removeAttr(e, t) : r && "set" in r && void 0 !== (i = r.set(e, n, t)) ? i: (e.setAttribute(t, n + ""), n) : r && "get" in r && null !== (i = r.get(e, t)) ? i: null == (i = w.find.attr(e, t)) ? void 0 : i)
        },
        attrHooks: {
            type: {
                set: function(e, t) {
    ...
    function(e, t) {
        ...
        ht[t] = function(e, t, i) {
            ...
            return i || (s = ht[o], ht[o] = r, r = null != n(e, t, i) ? o: null, ht[o] = s),
            r
        }
    });
    ...
    w.extend({
        prop: function(e, t, n) {
            var i, r, s = e.nodeType;
            if (3 !== s && 8 !== s && 2 !== s) return 1 === s && w.isXMLDoc(e) || (t = w.propFix[t] || t, r = w.propHooks[t]),
    ...
    w.fn.extend({
        val: function(e) {
            ...
            return arguments.length ? (i = m(e), this.each(function(n) {
                var r;
                1 === this.nodeType && (null == (r = i ? e.call(this, n, w(this).val()) : e) ? r = "": "number" == typeof r ? r += "": Array.isArray(r) && (r = w.map(r,
                function(e) {
                    return null == e ? "": e + ""
        ...
        valHooks: {
            ...
            select: {
                get: function(e) {
                    ...
                    a = o ? null: [],
                    l = o ? s + 1 : r.length;
                    for (i = s < 0 ? l: o ? s: 0; i < l; i++) if (((n = r[i]).selected || i === s) && !n.disabled && (!n.parentNode.disabled || !E(n.parentNode, "optgroup"))) {
                ...
                set: function(e, t) {
                    ...
                    s = w.makeArray(t), o = r.length; o--;)((i = r[o]).selected = w.inArray(w.valHooks.option.get(i), s) > -1) && (n = !0);
    ...
    w.extend(w.event, {
        trigger: function(t, n, r, s) {
            ...
            s || !f.trigger || !1 !== f.trigger.apply(r, n))) {
                if (!s && !f.noBubble && !g(r)) {
                    for (c = f.delegateType || y, yt.test(c + y) || (a = a.parentNode); a; a = a.parentNode) v.push(a),
                    l = a;
                    l === (r.ownerDocument || i) && v.push(l.defaultView || l.parentWindow || e)
                }
                for (o = 0; (a = v[o++]) && !t.isPropagationStopped();) p = a,
                ...
                return t.type = y,
                s || t.isDefaultPrevented() || f._default && !1 !== f._default.apply(v.pop(), n) || !z(r) || u && m(r[y]) && !g(r) && ((l = r[u]) && (r[u] = null), w.event.triggered = y, t.isPropagationStopped() && p.addEventListener(y, _t), r[y](), t.isPropagationStopped() && p.removeEventListener(y, _t), w.event.triggered = void 0, l && (r[u] = l)),
                t.result
            }
        },
    ...
    function Ht(e) {
        return function(t, n) {
            ...
            if (m(n)) for (; i = s[r++];)"+" === i[0] ? (i = i.slice(1) || "*", (e[i] = e[i] || []).unshift(n)) : (e[i] = e[i] || []).push(n)
        }
    }
    function $t(e, t, n, i) {
        var r = {},
    ...
    w.extend({
        ...
        ajax: function(t, n) {
            ...
            n = n || {};
            var r, s, o, a, l, c, u, h, d, f, p = w.ajaxSetup({},
            n),
            m = p.context || p,
            ...
            x = {
                ...
                getResponseHeader: function(e) {
                    var t;
                    if (u) {
                        if (!a) for (a = {}; t = Mt.exec(o);) a[t[1].toLowerCase()] = t[2];
                        t = a[e.toLowerCase()]
                    }
                ...
                setRequestHeader: function(e, t) {
                    return null == u && (e = D[e.toLowerCase()] = D[e.toLowerCase()] || e, b[e] = t),
                    this
                },
            ...
            if (v.promise(x), p.url = ((t || p.url || bt.href) + "").replace(Nt, bt.protocol + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = (p.dataType || "*").toLowerCase().match(Y) || [""], null == p.crossDomain) {
                c = i.createElement("a");
                try {
                    c.href = p.url,
                    c.href = c.href,
                    p.crossDomain = jt.protocol + "//" + jt.host != c.protocol + "//" + c.host
                } catch(e) {
                    p.crossDomain = !0
                }
            }
            if (p.data && p.processData && "string" != typeof p.data && (p.data = w.param(p.data, p.traditional)), $t(Pt, p, n, x), u) return x;
            for (d in (h = w.event && p.global) && 0 == w.active++&&w.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !It.test(p.type), s = p.url.replace(At, ""), p.hasContent ? p.data && p.processData && 0 === (p.contentType || "").indexOf("application/x-www-form-urlencoded") && (p.data = p.data.replace(Et, "+")) : (f = p.url.slice(s.length), p.data && (p.processData || "string" == typeof p.data) && (s += (Dt.test(s) ? "&": "?") + p.data, delete p.data), !1 === p.cache && (s = s.replace(Ot, "$1"), f = (Dt.test(s) ? "&": "?") + "_=" + wt+++f), p.url = s + f), p.ifModified && (w.lastModified[s] && x.setRequestHeader("If-Modified-Since", w.lastModified[s]), w.etag[s] && x.setRequestHeader("If-None-Match", w.etag[s])), (p.data && p.hasContent && !1 !== p.contentType || n.contentType) && x.setRequestHeader("Content-Type", p.contentType), x.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + Yt + "; q=0.01": "") : p.accepts["*"]), p.headers) x.setRequestHeader(d, p.headers[d]);
            if (p.beforeSend && (!1 === p.beforeSend.call(m, x, p) || u)) return x.abort();
            if (C = "abort", y.add(p.complete), x.done(p.success), x.fail(p.error), r = $t(Lt, p, n, x)) {
            ...
            function k(t, n, i, a) {
                var c, d, f, b, D, C = n;
                u || (u = !0, l && e.clearTimeout(l), r = void 0, o = a || "", x.readyState = t > 0 ? 4 : 0, c = t >= 200 && t < 300 || 304 === t, i && (b = function(e, t, n) {
                    ...
                    for (s = u.shift(); s;) if (e.responseFields[s] && (n[e.responseFields[s]] = t), !l && i && e.dataFilter && (t = e.dataFilter(t, e.dataType)), l = s, s = u.shift()) if ("*" === s) s = l;
                        ...
                        if (! (o = c[l + " " + s] || c["* " + s])) for (r in c) if ((a = r.split(" "))[1] === s && (o = c[l + " " + a[0]] || c["* " + a[0]])) { ! 0 === o ? o = c[r] : !0 !== c[r] && (s = a[0], u.unshift(a[1]));
                            break
                        }
    ...
    function(t, n, i) {
        ...
        a ? t[a] = t[a].replace(Bt, "$1" + r) : !1 !== t.jsonp && (t.url += (Dt.test(t.url) ? "&": "?") + t.jsonp + "=" + r),
    ...
    p.createHTMLDocument = ((Ft = i.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Ft.childNodes.length),
    w.parseHTML = function(e, t, n) {
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (p.createHTMLDocument ? ((r = (t = i.implementation.createHTMLDocument("")).createElement("base")).href = i.location.href, t.head.appendChild(r)) : t = i), s = A.exec(e), o = !n && [], s ? [t.createElement(s[1])] : (s = ye([e], t, o), o && o.length && w(o).remove(), w.merge([], s.childNodes)));
        var r, s, o
    }, w.fn.load = function(e, t, n) {
        var i, r, s, o = this,
        a = e.indexOf(" ");
        return a > -1 && (i = pt(e.slice(a)), e = e.slice(0, a)),
    ...
    w.offset = {
        setOffset: function(e, t, n) {
            var i, r, s, o, a, l, c = w.css(e, "position"),
            u = w(e),
            h = {};
    ...
    w.each(["top", "left"],
    function(e, t) {
        w.cssHooks[t] = We(p.pixelPosition,
        function(e, n) {
    ...
    function(e, t) {
        ...
        function(n, i) {
            w.fn[i] = function(r, s) {
                ...
                function(t, n, r) {
                    var s;
                    return g(t) ? 0 === i.indexOf("outer") ? t["inner" + e] : t.document.documentElement["client" + e] : 9 === t.nodeType ? (s = t.documentElement, Math.max(t.body["scroll" + e], s["scroll" + e], t.body["offset" + e], s["offset" + e], s["client" + e])) : void 0 === r ? w.css(t, n, a) : w.style(t, n, r, a)
                },
                t, o ? r: void 0, o)
            }
        })
    ...
    w.proxy = function(e, t) {
        var n, i, r;
        if ("string" == typeof t && (n = e[t], t = e, e = n), m(e)) return i = s.call(arguments, 2),
        (r = function() {
...
function(e, t) {
    ...
    for (var s, o, a, l, c, u, h, d, f, p, m, g, v, y, _, b, w, D, C, x, k, S, T, E, A, O, M, I, N, P, L, Y, j, H, $, R, W, q, F, U, B, V, G, z, K, Q, Z, X, J, ee, te, ne, ie, re, se, oe, ae, le, ce, ue, he, de, fe, pe, me = function(e) {
        var t = "transitionend";
        function n(t) {
            var n = this,
            r = !1;
...
default:
    t), ge = (o = "alert", l = "." + (a = "bs.alert"), c = (s = t).fn[o], u = {
        CLOSE: "close" + l,
        CLOSED: "closed" + l,
    ...
    h = "alert", d = "fade", f = "show", p = function() {
        ...
        e
    } (), s(document).on(u.CLICK_DATA_API, '[data-dismiss="alert"]', p._handleDismiss(new p)), s.fn[o] = p._jQueryInterface, s.fn[o].Constructor = p, s.fn[o].noConflict = function() {
        return s.fn[o] = c,
        p._jQueryInterface
    },
    ...
    O = function() {
        ...
        return t.toggle = function() {
            ...
            if (n) {
                ...
                if (i) {
                    if ("radio" === i.type) if (i.checked && this._element.classList.contains(w)) e = !1;
                    else {
            ...
            t && this._element.setAttribute("aria-pressed", !this._element.classList.contains(w)),
        ...
        e._jQueryInterface = function(t) {
            return this.each(function() {
                var n = m(this).data(v);
                n || (n = new e(this), m(this).data(v, n)),
                "toggle" === t && n[t]()
            })
        },
        i(e, null, [{
        ...
        e
    } (), m(document).on(A.CLICK_DATA_API, x,
    function(e) {
        e.preventDefault();
        var t = e.target;
    ...
    O), ye = (I = "carousel", P = "." + (N = "bs.carousel"), L = ".data-api", Y = (M = t).fn[I], j = {
        interval: 5e3,
        keyboard: !0,
        slide: !1,
        pause: "hover",
    ...
    X = function() {
        ...
        t.nextWhenVisible = function() { ! document.hidden && M(this._element).is(":visible") && "hidden" !== M(this._element).css("visibility") && this.next()
        },
        t.prev = function() {
        ...
        t.pause = function(e) {
            e || (this._isPaused = !0),
            this._element.querySelector(Z.NEXT_PREV) && (me.triggerTransitionEnd(this._element), this.cycle(!0)),
        ...
        t.to = function(e) {
            ...
            if (! (e > this._items.length - 1 || e < 0)) if (this._isSliding) M(this._element).one(F.SLID,
            function() {
                return t.to(e)
            });
            else {
        ...
        t._addEventListeners = function() {
            var e = this;
            this._config.keyboard && M(this._element).on(F.KEYDOWN,
            function(t) {
                return e._keydown(t)
            }),
            "hover" === this._config.pause && (M(this._element).on(F.MOUSEENTER,
            function(t) {
                return e.pause(t)
            }).on(F.MOUSELEAVE,
            function(t) {
                return e.cycle(t)
            }), "ontouchstart" in document.documentElement && M(this._element).on(F.TOUCHEND,
            function() {
                e.pause(),
        ...
        t._triggerSlideEvent = function(e, t) {
            ...
            return M(this._element).trigger(r),
            r
        },
        ...
        t._slide = function(e, t) {
            ...
            if (e === $ ? (n = z, i = K, r = W) : (n = G, i = Q, r = q), l && M(l).hasClass(B)) this._isSliding = !1;
                ...
                if (M(this._element).hasClass(V)) {
                    ...
                    M(o).addClass(n),
                    M(l).addClass(n);
                    var d = me.getTransitionDurationFromElement(o);
                    M(o).one(me.TRANSITION_END,
                    function() {
                        M(l).removeClass(n + " " + i).addClass(B),
                        M(o).removeClass(B + " " + i + " " + n),
                        s._isSliding = !1,
                        setTimeout(function() {
                            return M(s._element).trigger(h)
                        },
                        0)
                    }).emulateTransitionEnd(d)
                } else M(o).removeClass(B),
                M(l).addClass(B),
                this._isSliding = !1,
        ...
        e._jQueryInterface = function(t) {
            return this.each(function() {
                ...
                if (n || (n = new e(this, i), M(this).data(N, n)), "number" == typeof t) n.to(t);
        ...
        e
    } (), M(document).on(F.CLICK_DATA_API, Z.DATA_SLIDE, X._dataApiClickHandler), M(window).on(F.LOAD_DATA_API,
    function() {
    ...
    pe = function() {
        function e(e, t) {
            ...
            this._element = e,
            this._config = this._getConfig(t),
            this._triggerArray = J.makeArray(document.querySelectorAll('[data-toggle="collapse"][href="#' + e.id + '"],[data-toggle="collapse"][data-target="#' + e.id + '"]'));
        ...
        t.show = function() {
            ...
            if (!this._isTransitioning && !J(this._element).hasClass(ae) && (this._parent && 0 === (t = [].slice.call(this._parent.querySelectorAll(fe.ACTIVES)).filter(function(e) {
                ...
                if (J(this._element).trigger(r), !r.isDefaultPrevented()) {
                    ...
                    J(this._element).removeClass(le).addClass(ce),
                    this._element.style[s] = 0,
                    this._triggerArray.length && J(this._triggerArray).removeClass(ue).attr("aria-expanded", !0),
                    this.setTransitioning(!0);
                    var o = "scroll" + (s[0].toUpperCase() + s.slice(1)),
                    a = me.getTransitionDurationFromElement(this._element);
                    J(this._element).one(me.TRANSITION_END,
                    function() {
                        J(i._element).removeClass(ce).addClass(le).addClass(ae),
                        i._element.style[s] = "",
                        i.setTransitioning(!1),
                        J(i._element).trigger(oe.SHOWN)
        ...
        t.hide = function() {
            ...
            if (!this._isTransitioning && J(this._element).hasClass(ae)) {
                ...
                if (J(this._element).trigger(t), !t.isDefaultPrevented()) {
                    ...
                    J(this._element).addClass(ce).removeClass(le).removeClass(ae);
                    var i = this._triggerArray.length;
                    if (i > 0) for (var r = 0; r < i; r++) {
                        var s = this._triggerArray[r],
                        o = me.getSelectorFromElement(s);
                        if (null !== o) J([].slice.call(document.querySelectorAll(o))).hasClass(ae) || J(s).addClass(ue).attr("aria-expanded", !1)
                    }
                    this.setTransitioning(!0);
                    ...
                    function() {
                        ...
                        J(e._element).removeClass(ce).addClass(le).trigger(oe.HIDDEN)
                    }).emulateTransitionEnd(a)
                }
            }
        },
        ...
        e._jQueryInterface = function(t) {
            return this.each(function() {
                ...
                i = n.data(te),
                s = r({},
                re, n.data(), "object" == typeof t && t ? t: {});
                if (!i && s.toggle && /show|hide/.test(t) && (s.toggle = !1), i || (i = new e(this, s), n.data(te, i)), "string" == typeof t) {
        ...
        e
    } (), J(document).on(oe.CLICK_DATA_API, fe.DATA_TOGGLE,
    function(e) {
    ...
    function Pe(e, t) {
        ...
        if (e !== l && t !== l || i.contains(r)) return "BODY" === (a = (o = l).nodeName) || "HTML" !== a && Ie(o.firstElementChild) !== o ? Ie(l) : l;
        var c = Ne(e);
    ...
    function Be(e, t) {
        ...
        n && "HTML" === t.nodeName && (o.top = Math.max(o.top, 0), o.left = Math.max(o.left, 0));
        var h = Fe({
            top: s.top - o.top - c,
    ...
    function at(e, t) {
        Object.keys(t).forEach(function(n) {
            var i = ""; - 1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(n) && ot(t[n]) && (i = "px"),
            e.style[n] = t[n] + i
        })
    }
    function lt(e, t, n) {
        ...
        modifiers: {
            ...
            keepTogether: {
                ...
                fn: function(e) {
                    ...
                    l = o ? "left": "top",
                    c = o ? "width": "height";
                    return n[a] < s(i[l]) && (e.offsets.popper[l] = s(i[l]) - n[c]),
            ...
            arrow: {
                ...
                fn: function(e, t) {
                    ...
                    f = l ? "bottom": "right",
                    p = Qe(i)[c];
                    a[f] - p < o[h] && (e.offsets.popper[h] -= o[h] - (a[f] - p)),
                    a[h] + p > o[f] && (e.offsets.popper[h] += a[h] + p - o[f]),
                    ...
                    return _ = Math.max(Math.min(o[c] - p, _), 0),
                    e.arrowElement = i,
                    e.offsets.arrow = (We(n = {},
                    h, Math.round(_)), We(n, d, ""), n),
                    e
                },
                element: "[x-arrow]"
            },
            flip: {
                ...
                fn: function(e, t) {
                    ...
                    return o.forEach(function(a, l) {
                        ...
                        b = !!t.flipVariations && (_ && "start" === s && p || _ && "end" === s && m || !_ && "start" === s && g || !_ && "end" === s && v); (f || y || b) && (e.flipped = !0, (f || y) && (i = o[l + 1]), b && (s = "end" === (c = s) ? "start": "start" === c ? "end": c), e.placement = i + (s ? "-" + s: ""), e.offsets.popper = qe({},
                        e.offsets.popper, Xe(e.instance.popper, e.offsets.reference, e.placement)), e = et(e.instance.modifiers, e, "flip"))
                    }),
                    e
                },
                behavior: "flip",
            ...
            computeStyle: {
                ...
                fn: function(e, t) {
                    ...
                    f = void 0,
                    p = void 0;
                    if (p = "bottom" === u ? -a.height + c.bottom: c.top, f = "right" === h ? -a.width + c.right: c.left, o && d) l[d] = "translate3d(" + f + "px, " + p + "px, 0)",
                    l[u] = 0,
                    l[h] = 0,
            ...
            applyStyle: {
                ...
                onLoad: function(e, t, n, i, r) {
                    ...
                    o = ze(n.placement, s, t, e, n.modifiers.flip.boundariesElement, n.modifiers.flip.padding);
            ...
            value: function() {
                return function() {
                    if (!this.state.isDestroyed) {
                        ...
                        e.offsets.reference = Ke(this.state, this.popper, this.reference, this.options.positionFixed),
        ...
        },
        {
            ...
            value: function() {
                return function() {
                    ...
                    tt(this.modifiers, "applyStyle") && (this.popper.removeAttribute("x-placement"), this.popper.style.position = "", this.popper.style.top = "", this.popper.style.left = "", this.popper.style.right = "", this.popper.style.bottom = "", this.popper.style.willChange = "", this.popper.style[nt("transform")] = ""),
    ...
    mt.placements = ct,
    mt.Defaults = pt;
    var gt, vt, yt, _t, bt, wt, Dt, Ct, xt, kt, St, Tt, Et, At, Ot, Mt, It, Nt, Pt, Lt, Yt, jt, Ht, $t, Rt, Wt, qt, Ft, Ut, Bt, Vt, Gt, zt, Kt, Qt, Zt, Xt, Jt, en, tn, nn, rn, sn, on, an, ln, cn, un, hn, dn, fn, pn, mn, gn, vn, yn, _n, bn, wn, Dn, Cn, xn, kn, Sn, Tn, En, An, On, Mn, In, Nn, Pn, Ln, Yn, jn, Hn, $n, Rn, Wn, qn, Fn, Un, Bn, Vn, Gn, zn, Kn, Qn, Zn, Xn, Jn, ei, ti, ni, ii, ri, si, oi, ai, li, ci, ui, hi, di, fi, pi, mi, gi, vi, yi, _i, bi, wi, Di = (vt = "dropdown", _t = "." + (yt = "bs.dropdown"), bt = ".data-api", wt = (gt = t).fn[vt], Dt = new RegExp("38|40|27"), Ct = {
        HIDE: "hide" + _t,
        HIDDEN: "hidden" + _t,
        SHOW: "show" + _t,
        SHOWN: "shown" + _t,
    ...
    xt = "disabled", kt = "show", St = "dropup", Tt = "dropright", Et = "dropleft", At = "dropdown-menu-right", Ot = "position-static", Mt = '[data-toggle="dropdown"]', It = ".dropdown form", Nt = ".dropdown-menu", Pt = ".navbar-nav", Lt = ".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", Yt = "top-start", jt = "top-end", Ht = "bottom-start", $t = "bottom-end", Rt = "right-start", Wt = "left-start", qt = {
        offset: 0,
        flip: !0,
    ...
    Ut = function() {
                ...
                if (e._clearMenus(), !n) {
                    ...
                    if (gt(t).trigger(r), !r.isDefaultPrevented()) {
                        if (!this._inNavbar) {
                            ...
                            var s = this._element;
                            "parent" === this._config.reference ? s = t: me.isElement(this._config.reference) && (s = this._config.reference, void 0 !== this._config.reference.jquery && (s = this._config.reference[0])),
                            "scrollParent" !== this._config.boundary && gt(t).addClass(Ot),
                            this._popper = new mt(s, this._menu, this._getPopperConfig())
                        }
                        ...
                        gt(t).toggleClass(kt).trigger(gt.Event(Ct.SHOWN, i))
                    }
                }
            }
        },
        ...
        t._getConfig = function(e) {
            return e = r({},
            this.constructor.Default, gt(this._element).data(), e),
            me.typeCheckConfig(vt, e, this.constructor.DefaultType),
            e
        },
        ...
        t._getPlacement = function() {
            ...
            t = Ht;
            return e.hasClass(St) ? (t = Yt, gt(this._menu).hasClass(At) && (t = jt)) : e.hasClass(Tt) ? t = Rt: e.hasClass(Et) ? t = Wt: gt(this._menu).hasClass(At) && (t = $t),
            t
        },
        ...
        e._clearMenus = function(t) {
            if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which)) for (var n = [].slice.call(document.querySelectorAll(Mt)), i = 0, r = n.length; i < r; i++) {
                ...
                if (t && "click" === t.type && (a.clickEvent = t), o) {
                    var l = o._menu;
                    if (gt(s).hasClass(kt) && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && gt.contains(s, t.target))) {
                        var c = gt.Event(Ct.HIDE, a);
                        gt(s).trigger(c),
                        c.isDefaultPrevented() || ("ontouchstart" in document.documentElement && gt(document.body).children().off("mouseover", null, gt.noop), n[i].setAttribute("aria-expanded", "false"), gt(l).removeClass(kt), gt(s).removeClass(kt).trigger(gt.Event(Ct.HIDDEN, a)))
                    }
                }
            }
        },
        ...
        e._dataApiKeydownHandler = function(t) {
            if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || gt(t.target).closest(Nt).length)) : Dt.test(t.which)) && (t.preventDefault(), t.stopPropagation(), !this.disabled && !gt(this).hasClass(xt))) {
                ...
                if ((i || 27 === t.which && 32 === t.which) && (!i || 27 !== t.which && 32 !== t.which)) {
                    var r = [].slice.call(n.querySelectorAll(Lt));
                    if (0 !== r.length) {
        ...
        e
    } (), gt(document).on(Ct.KEYDOWN_DATA_API, Mt, Ut._dataApiKeydownHandler).on(Ct.KEYDOWN_DATA_API, Nt, Ut._dataApiKeydownHandler).on(Ct.CLICK_DATA_API + " " + Ct.KEYUP_DATA_API, Ut._clearMenus).on(Ct.CLICK_DATA_API, Mt,
    function(e) {
        e.preventDefault(),
        e.stopPropagation(),
        Ut._jQueryInterface.call(gt(this), "toggle")
    }).on(Ct.CLICK_DATA_API, It,
    function(e) {
        e.stopPropagation()
    ...
    Ut),
    Ci = (Vt = "modal", zt = "." + (Gt = "bs.modal"), Kt = (Bt = t).fn[Vt], Qt = {
        backdrop: !0,
        keyboard: !0,
        focus: !0,
        show: !0
    ...
    Jt = "modal-scrollbar-measure", en = "modal-backdrop", tn = "modal-open", nn = "fade", rn = "show", sn = {
        DIALOG: ".modal-dialog",
    ...
    on = function() {
        ...
        t.show = function(e) {
            ...
            if (!this._isTransitioning && !this._isShown) {
                ...
                var n = Bt.Event(Xt.SHOW, {
                    relatedTarget: e
                });
                Bt(this._element).trigger(n),
                this._isShown || n.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), Bt(document.body).addClass(tn), this._setEscapeEvent(), this._setResizeEvent(), Bt(this._element).on(Xt.CLICK_DISMISS, sn.DATA_DISMISS,
                function(e) {
                    return t.hide(e)
                }), Bt(this._dialog).on(Xt.MOUSEDOWN_DISMISS,
                function() {
                    Bt(t._element).one(Xt.MOUSEUP_DISMISS,
                    function(e) {
            ...
            if (e && e.preventDefault(), !this._isTransitioning && this._isShown) {
                ...
                if (Bt(this._element).trigger(n), this._isShown && !n.isDefaultPrevented()) {
                    ...
                    if (i && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), Bt(document).off(Xt.FOCUSIN), Bt(this._element).removeClass(rn), Bt(this._element).off(Xt.CLICK_DISMISS), Bt(this._dialog).off(Xt.MOUSEDOWN_DISMISS), i) {
                        ...
                        Bt(this._element).one(me.TRANSITION_END,
                        function(e) {
        ...
        t.dispose = function() {
            ...
            Bt(window, document, this._element, this._backdrop).off(zt),
            this._config = null,
            this._element = null,
            this._dialog = null,
            this._backdrop = null,
        ...
        t._showElement = function(e) {
            ...
            if (n) {
                var s = me.getTransitionDurationFromElement(this._element);
                Bt(this._dialog).one(me.TRANSITION_END, r).emulateTransitionEnd(s)
            } else r()
        },
        t._enforceFocus = function() {
            var e = this;
            Bt(document).off(Xt.FOCUSIN).on(Xt.FOCUSIN,
            function(t) {
        ...
        t._setEscapeEvent = function() {
            var e = this;
            this._isShown && this._config.keyboard ? Bt(this._element).on(Xt.KEYDOWN_DISMISS,
            function(t) {
        ...
        t._setResizeEvent = function() {
            var e = this;
            this._isShown ? Bt(window).on(Xt.RESIZE,
            function(t) {
        ...
        t._showBackdrop = function(e) {
            ...
            if (this._isShown && this._config.backdrop) {
                if (this._backdrop = document.createElement("div"), this._backdrop.className = en, n && this._backdrop.classList.add(n), Bt(this._backdrop).appendTo(document.body), Bt(this._element).on(Xt.CLICK_DISMISS,
                function(e) {
                ...
                if (Bt(this._element).hasClass(nn)) {
                    var s = me.getTransitionDurationFromElement(this._backdrop);
                    Bt(this._backdrop).one(me.TRANSITION_END, r).emulateTransitionEnd(s)
                } else r()
            } else e && e()
        },
        ...
        t._setScrollbar = function() {
            ...
            if (this._isBodyOverflowing) {
                var t = [].slice.call(document.querySelectorAll(sn.FIXED_CONTENT)),
                n = [].slice.call(document.querySelectorAll(sn.STICKY_CONTENT));
        ...
        t._resetScrollbar = function() {
            var e = [].slice.call(document.querySelectorAll(sn.FIXED_CONTENT));
            Bt(e).each(function(e, t) {
                var n = Bt(t).data("padding-right");
                Bt(t).removeData("padding-right"),
                t.style.paddingRight = n || ""
            });
            var t = [].slice.call(document.querySelectorAll("" + sn.STICKY_CONTENT));
        ...
        e._jQueryInterface = function(t, n) {
            return this.each(function() {
                ...
                s = r({},
                Qt, Bt(this).data(), "object" == typeof t && t ? t: {});
                if (i || (i = new e(this, s), Bt(this).data(Gt, i)), "string" == typeof t) {
                    if (void 0 === i[t]) throw new TypeError('No method named "' + t + '"');
                    i[t](n)
        ...
        e
    } (), Bt(document).on(Xt.CLICK_DATA_API, sn.DATA_TOGGLE,
    function(e) {
        var t, n = this,
        i = me.getSelectorFromElement(this);
        i && (t = document.querySelector(i));
        var s = Bt(t).data(Gt) ? "toggle": r({},
        Bt(t).data(), Bt(this).data());
        "A" !== this.tagName && "AREA" !== this.tagName || e.preventDefault();
        var o = Bt(t).one(Xt.SHOW,
        function(e) {
            e.isDefaultPrevented() || o.one(Xt.HIDDEN,
            function() {
                Bt(n).is(":visible") && n.focus()
            })
        });
        on._jQueryInterface.call(Bt(t), s, this)
    }), Bt.fn[Vt] = on._jQueryInterface, Bt.fn[Vt].Constructor = on, Bt.fn[Vt].noConflict = function() {
        return Bt.fn[Vt] = Kt,
        on._jQueryInterface
    },
    on),
    ...
    bn = "fade", wn = "show", Dn = ".tooltip-inner", Cn = ".arrow", xn = "hover", kn = "focus", Sn = "click", Tn = "manual", En = function() {
        ...
        t.toggle = function(e) {
            if (this._isEnabled) if (e) {
                ...
                n || (n = new this.constructor(e.currentTarget, this._getDelegateConfig()), an(e.currentTarget).data(t, n)),
        ...
        t.hide = function(e) {
            ...
            if (an(this.element).trigger(i), !i.isDefaultPrevented()) {
                if (an(n).removeClass(wn), "ontouchstart" in document.documentElement && an(document.body).children().off("mouseover", null, an.noop), this._activeTrigger[Sn] = !1, this._activeTrigger[kn] = !1, this._activeTrigger[xn] = !1, an(this.tip).hasClass(bn)) {
                    var s = me.getTransitionDurationFromElement(n);
                    an(n).one(me.TRANSITION_END, r).emulateTransitionEnd(s)
                } else r();
                this._hoverState = ""
            }
        },
        ...
        t.setContent = function() {
            ...
            this.setElementContent(an(e.querySelectorAll(Dn)), this.getTitle()),
        ...
        t._setListeners = function() {
            ...
            this.config.trigger.split(" ").forEach(function(t) {
                if ("click" === t) an(e.element).on(e.constructor.Event.CLICK, e.config.selector,
                function(t) {
                    return e.toggle(t)
                });
                else if (t !== Tn) {
                    ...
                    an(e.element).on(n, e.config.selector,
                    function(t) {
                        return e._enter(t)
                ...
                an(e.element).closest(".modal").on("hide.bs.modal",
                function() {
                    return e.hide()
                })
            }),
        ...
        t._enter = function(e, t) {
            var n = this.constructor.DATA_KEY; (t = t || an(e.currentTarget).data(n)) || (t = new this.constructor(e.currentTarget, this._getDelegateConfig()), an(e.currentTarget).data(n, t)),
            e && (t._activeTrigger["focusin" === e.type ? kn: xn] = !0),
            an(t.getTipElement()).hasClass(wn) || t._hoverState === vn ? t._hoverState = vn: (clearTimeout(t._timeout), t._hoverState = vn, t.config.delay && t.config.delay.show ? t._timeout = setTimeout(function() {
        ...
        t._leave = function(e, t) {
            var n = this.constructor.DATA_KEY; (t = t || an(e.currentTarget).data(n)) || (t = new this.constructor(e.currentTarget, this._getDelegateConfig()), an(e.currentTarget).data(n, t)),
            e && (t._activeTrigger["focusout" === e.type ? kn: xn] = !1),
            t._isWithActiveTrigger() || (clearTimeout(t._timeout), t._hoverState = yn, t.config.delay && t.config.delay.hide ? t._timeout = setTimeout(function() {
        ...
        t._getConfig = function(e) {
            return "number" == typeof(e = r({},
            this.constructor.Default, an(this.element).data(), "object" == typeof e && e ? e: {})).delay && (e.delay = {
                show: e.delay,
                hide: e.delay
            }),
            "number" == typeof e.title && (e.title = e.title.toString()),
            "number" == typeof e.content && (e.content = e.content.toString()),
            me.typeCheckConfig(ln, e, this.constructor.DefaultType),
            e
        },
    ...
    En),
    ki = (On = "popover", In = "." + (Mn = "bs.popover"), Nn = (An = t).fn[On], Pn = "bs-popover", Ln = new RegExp("(^|\\s)" + Pn + "\\S+", "g"), Yn = r({},
    xi.Default, {
        placement: "right",
        trigger: "click",
        content: "",
    ...
    }), Hn = "fade", $n = "show", Rn = ".popover-header", Wn = ".popover-body", qn = {
        HIDE: "hide" + In,
        HIDDEN: "hidden" + In,
        SHOW: "show" + In,
        SHOWN: "shown" + In,
    ...
    Fn),
    Si = (Bn = "scrollspy", Gn = "." + (Vn = "bs.scrollspy"), zn = (Un = t).fn[Bn], Kn = {
        offset: 10,
        method: "auto",
        target: ""
    },
    ...
    ti = "offset", ni = "position", ii = function() {
        function e(e, t) {
            ...
            Un(this._scrollElement).on(Zn.SCROLL,
            function(e) {
                return n._process(e)
            }),
            this.refresh(),
        ...
        return t.refresh = function() {
            ...
            [].slice.call(document.querySelectorAll(this._selector)).map(function(e) {
                ...
                if (r && (t = document.querySelector(r)), t) {
                    ...
                    if (s.width || s.height) return [Un(t)[n]().top + i, r]
                }
                return null
            }).filter(function(e) {
                return e
        ...
        t._getConfig = function(e) {
            ...
            Kn, "object" == typeof e && e ? e: {})).target) {
                var t = Un(e.target).attr("id");
                t || (t = me.getUID(Bn), Un(e.target).attr("id", t)),
                e.target = "#" + t
            }
            return me.typeCheckConfig(Bn, e, Qn),
            e
        },
        ...
        t._activate = function(e) {
            ...
            n.hasClass(Xn) ? (n.closest(ei.DROPDOWN).find(ei.DROPDOWN_TOGGLE).addClass(Jn), n.addClass(Jn)) : (n.addClass(Jn), n.parents(ei.NAV_LIST_GROUP).prev(ei.NAV_LINKS + ", " + ei.LIST_ITEMS).addClass(Jn), n.parents(ei.NAV_LIST_GROUP).prev(ei.NAV_ITEMS).children(ei.NAV_LINKS).addClass(Jn)),
    ...
    ii),
    Ti = (oi = "." + (si = "bs.tab"), ai = (ri = t).fn.tab, li = {
        HIDE: "hide" + oi,
        HIDDEN: "hidden" + oi,
        SHOW: "show" + oi,
        SHOWN: "shown" + oi,
    ...
    ci = "dropdown-menu", ui = "active", hi = "disabled", di = "fade", fi = "show", pi = ".dropdown", mi = ".nav, .list-group", gi = ".active", vi = "> li > .active", yi = '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', _i = ".dropdown-toggle", bi = "> .dropdown-menu .active", wi = function() {
        ...
        return t.show = function() {
            ...
            if (! (this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && ri(this._element).hasClass(ui) || ri(this._element).hasClass(hi))) {
                ...
                r = me.getSelectorFromElement(this._element);
                if (i) {
                    var s = "UL" === i.nodeName ? vi: gi;
                    n = (n = ri.makeArray(ri(i).find(s)))[n.length - 1]
                }
                ...
                if (n && ri(n).trigger(o), ri(this._element).trigger(a), !a.isDefaultPrevented() && !o.isDefaultPrevented()) {
        ...
        t._activate = function(e, t, n) {
            ...
            if (r && s) {
                ...
                ri(r).one(me.TRANSITION_END, o).emulateTransitionEnd(a)
            } else o()
        },
        t._transitionComplete = function(e, t, n) {
            ...
            if (ri(e).addClass(ui), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), me.reflow(e), ri(e).addClass(fi), e.parentNode && ri(e.parentNode).hasClass(ci)) {
                ...
                if (r) {
                    var s = [].slice.call(r.querySelectorAll(_i));
                    ri(s).addClass(ui)
                }
        ...
        e._jQueryInterface = function(t) {
            return this.each(function() {
                var n = ri(this),
                i = n.data(si);
                if (i || (i = new e(this), n.data(si, i)), "string" == typeof t) {
                    if (void 0 === i[t]) throw new TypeError('No method named "' + t + '"');
                    i[t]()
                }
            })
        ...
        e
    } (), ri(document).on(li.CLICK_DATA_API, yi,
    function(e) {
        e.preventDefault(),
...
function() {
    ...
    function g(e, t) {
        var n, i, r;
        if (s(t._isAMomentObject) || (e._isAMomentObject = t._isAMomentObject), s(t._i) || (e._i = t._i), s(t._f) || (e._f = t._f), s(t._l) || (e._l = t._l), s(t._strict) || (e._strict = t._strict), s(t._tzm) || (e._tzm = t._tzm), s(t._isUTC) || (e._isUTC = t._isUTC), s(t._offset) || (e._offset = t._offset), s(t._pf) || (e._pf = d(t)), s(t._locale) || (e._locale = t._locale), m.length > 0) for (n = 0; n < m.length; n++) s(r = t[i = m[n]]) || (e[i] = r);
        return e
    }
    var v = !1;
    function y(e) {
    ...
    function C(e) { ! 1 === n.suppressDeprecationWarnings && "undefined" != typeof console && console.warn && console.warn("Deprecation warning: " + e)
    }
    function x(e, t) {
        var i = !0;
        return u(function() {
    ...
    function A(e, t) {
        var n, i = u({},
        e);
        for (n in t) c(t, n) && (r(e[n]) && r(t[n]) ? (i[n] = {},
        u(i[n], e[n]), u(i[n], t[n])) : null != t[n] ? i[n] = t[n] : delete i[n]);
        for (n in e) c(e, n) && !c(t, n) && r(e[n]) && (i[n] = u({},
        i[n]));
        return i
    }
    function O(e) {
    ...
    function F(e, t) {
        return e.isValid() ? (t = U(t, e.localeData()), R[t] = R[t] ||
        function(e) {
            var t, n, i, r = e.match(H);
            for (t = 0, n = r.length; t < n; t++) W[r[t]] ? r[t] = W[r[t]] : r[t] = (i = r[t]).match(/\[[\s\S]/) ? i.replace(/^\[|\]$/g, "") : i.replace(/\\/g, "");
            return function(t) {
                var i, s = "";
                for (i = 0; i < n; i++) s += E(r[i]) ? r[i].call(t, e) : r[i];
                return s
            }
    ...
    function U(e, t) {
        ...
        for ($.lastIndex = 0; n >= 0 && $.test(e);) e = e.replace($, i),
        $.lastIndex = 0,
        n -= 1;
        return e
    }
    ...
    function ce(e, t) {
        return c(ae, e) ? ae[e](t._strict, t._locale) : new RegExp(ue(e.replace("\\", "").replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g,
        function(e, t, n, i, r) {
            return t || n || i || r
        })))
    }
    ...
    function He() {
        ...
        for (i.sort(e), r.sort(e), s.sort(e), t = 0; t < 12; t++) i[t] = ue(i[t]),
        r[t] = ue(r[t]);
    ...
    function We(e, t, n, i, r) {
        var s, o, a = 1 + 7 * (t - 1) + (7 + n - i) % 7 + Re(e, i, r);
        return a <= 0 ? o = Ce(s = e - 1) + a: a > Ce(e) ? (s = e + 1, o = a - Ce(e)) : (s = e, o = a),
        {
            year: s,
            dayOfYear: o
        }
    ...
    function qe(e, t, n) {
        var i, r, s = Re(e.year(), t, n),
        o = Math.floor((e.dayOfYear() - s - 1) / 7) + 1;
        return o < 1 ? i = o + Fe(r = e.year() - 1, t, n) : o > Fe(e.year(), t, n) ? (i = o - Fe(e.year(), t, n), r = e.year() + 1) : (r = e.year(), i = o),
        {
            week: i,
            year: r
        }
    ...
    function Qe() {
        ...
        c.push(r),
        c.push(s);
        for (o.sort(e), a.sort(e), l.sort(e), c.sort(e), t = 0; t < 7; t++) a[t] = ue(a[t]),
        l[t] = ue(l[t]),
        c[t] = ue(c[t]);
    ...
    function at(e, t) {
        var n;
        return e && (n = s(t) ? ct(e) : lt(e, t)) && (et = n),
        et._abbr
    }
    function lt(e, t) {
        if (null !== t) {
    ...
    function ct(e) {
        ...
        return function(e) {
            for (var t, n, i, r, s = 0; s < e.length;) {
                for (t = (r = st(e[s]).split("-")).length, n = (n = st(e[s + 1])) ? n.split("-") : null; t > 0;) {
    ...
    function ut(e) {
        var t, n = e._a;
        return n && -2 === d(e).overflow && (t = n[me] < 0 || n[me] > 11 ? me: n[ge] < 1 || n[ge] > Oe(n[pe], n[me]) ? ge: n[ve] < 0 || n[ve] > 24 || 24 === n[ve] && (0 !== n[ye] || 0 !== n[_e] || 0 !== n[be]) ? ve: n[ye] < 0 || n[ye] > 59 ? ye: n[_e] < 0 || n[_e] > 59 ? _e: n[be] < 0 || n[be] > 999 ? be: -1, d(e)._overflowDayOfYear && (t < pe || t > ge) && (t = ge), d(e)._overflowWeeks && -1 === t && (t = we), d(e)._overflowWeekday && -1 === t && (t = De), d(e).overflow = t),
        e
    }
    function ht(e, t, n) {
    ...
    function dt(e) {
        ...
        if (!e._d) {
            var l, c;
            for (l = e, c = new Date(n.now()), r = l._useUTC ? [c.getUTCFullYear(), c.getUTCMonth(), c.getUTCDate()] : [c.getFullYear(), c.getMonth(), c.getDate()], e._w && null == e._a[ge] && null == e._a[me] &&
            function(e) {
                var t, n, i, r, s, o, a, l;
                if (null != (t = e._w).GG || null != t.W || null != t.E) s = 1,
                o = 4,
                n = ht(t.GG, e._a[pe], qe(Tt(), 1, 4).year),
                i = ht(t.W, 1),
                ((r = ht(t.E, 1)) < 1 || r > 7) && (l = !0);
                else {
                ...
                i < 1 || i > Fe(n, s, o) ? d(e)._overflowWeeks = !0 : null != l ? d(e)._overflowWeekday = !0 : (a = We(n, i, r, s, o), e._a[pe] = a.year, e._dayOfYear = a.dayOfYear)
            } (e), null != e._dayOfYear && (o = ht(e._a[pe], r[pe]), (e._dayOfYear > Ce(o) || 0 === e._dayOfYear) && (d(e)._overflowDayOfYear = !0), i = $e(o, 0, e._dayOfYear), e._a[me] = i.getUTCMonth(), e._a[ge] = i.getUTCDate()), t = 0; t < 3 && null == e._a[t]; ++t) e._a[t] = a[t] = r[t];
            for (; t < 7; t++) e._a[t] = a[t] = null == e._a[t] ? 2 === t ? 1 : 0 : e._a[t];
            24 === e._a[ve] && 0 === e._a[ye] && 0 === e._a[_e] && 0 === e._a[be] && (e._nextDay = !0, e._a[ve] = 0),
            e._d = (e._useUTC ? $e: function(e, t, n, i, r, s, o) {
            ...
            e._w && void 0 !== e._w.d && e._w.d !== s && (d(e).weekdayMismatch = !0)
        }
    }
    ...
    function Ct(e) {
        ...
        if (r) {
            ...
            if (t = r[1], n = s, i = e, t && Be.indexOf(t) !== new Date(n[0], n[1], n[2]).getDay() && (d(i).weekdayMismatch = !0, i._isValid = !1, 1)) return;
            e._a = s,
    ...
    function xt(e) {
        if (e._f !== n.ISO_8601) if (e._f !== n.RFC_2822) {
            e._a = [],
            d(e).empty = !0;
            var t, i, r, s, o, a, l, u, h = "" + e._i,
            f = h.length,
            p = 0;
            for (r = U(e._f, e._locale).match(H) || [], t = 0; t < r.length; t++) s = r[t],
            (i = (h.match(ce(s, e)) || [])[0]) && ((o = h.substr(0, h.indexOf(i))).length > 0 && d(e).unusedInput.push(o), h = h.slice(h.indexOf(i) + i.length), p += i.length),
            W[s] ? (i ? d(e).empty = !1 : d(e).unusedTokens.push(s), a = s, u = e, null != (l = i) && c(he, a) && he[a](l, u._a, u, a)) : e._strict && !i && d(e).unusedTokens.push(s);
            d(e).charsLeftOver = f - p,
            h.length > 0 && d(e).unusedInput.push(h),
            e._a[ve] <= 12 && !0 === d(e).bigHour && e._a[ve] > 0 && (d(e).bigHour = void 0),
    ...
    function kt(e) {
        ...
        null === v || void 0 === b && "" === v ? p({
            nullInput: !0
        }) : ("string" == typeof v && (e._i = v = e._locale.preparse(v)), _(v) ? new y(ut(v)) : (a(v) ? e._d = v: i(b) ?
        function(e) {
            var t, n, i, r, s;
            if (0 === e._f.length) return d(e).invalidFormat = !0,
            void(e._d = new Date(NaN));
            for (r = 0; r < e._f.length; r++) s = 0,
            t = g({},
            e),
            null != e._useUTC && (t._useUTC = e._useUTC),
            t._f = e._f[r],
            xt(t),
            f(t) && (s += d(t).charsLeftOver, s += 10 * d(t).unusedTokens.length, d(t).score = s, (null == i || s < i) && (i = s, n = t));
            u(e, n || t)
        } (e) : b ? xt(e) : s(c = (t = e)._i) ? t._d = new Date(n.now()) : a(c) ? t._d = new Date(c.valueOf()) : "string" == typeof c ? (h = t, null === (m = yt.exec(h._i)) ? (_t(h), !1 === h._isValid && (delete h._isValid, Ct(h), !1 === h._isValid && (delete h._isValid, n.createFromInputFallback(h)))) : h._d = new Date( + m[1])) : i(c) ? (t._a = l(c.slice(0),
        function(e) {
        ...
        } (t) : o(c) ? t._d = new Date(c) : n.createFromInputFallback(t), f(e) || (e._d = null), e))
    }
    function St(e, t, n, s, o) {
        ...
        l._f = t,
        l._strict = s,
        (a = new y(ut(kt(l))))._nextDay && (a.add(1, "d"), a._nextDay = void 0),
        a
    }
    function Tt(e, t, n, i) {
        return St(e, t, n, i, !1)
    ...
    n.ISO_8601 = function() {},
    n.RFC_2822 = function() {};
    var Et = x("moment().min is deprecated, use moment.max instead. http://momentjs.com/guides/#/warnings/min-max/",
    function() {
        var e = Tt.apply(null, arguments);
        return this.isValid() && e.isValid() ? e < this ? this: e: p()
    }),
    At = x("moment().max is deprecated, use moment.min instead. http://momentjs.com/guides/#/warnings/min-max/",
    function() {
        var e = Tt.apply(null, arguments);
        return this.isValid() && e.isValid() ? e > this ? this: e: p()
    });
    ...
    function Ft(e, t) {
        ...
        t ? s[t] = e: s.milliseconds = e) : (a = Wt.exec(e)) ? (n = "-" === a[1] ? -1 : 1, s = {
            y: 0,
            d: w(a[ge]) * n,
            h: w(a[ve]) * n,
            m: w(a[ye]) * n,
            ...
            t = Ht(t, e),
            e.isBefore(t) ? n = Bt(e, t) : ((n = Bt(t, e)).milliseconds = -n.milliseconds, n.months = -n.months);
            return n
        } (Tt(s.from), Tt(s.to)), (s = {}).ms = r.milliseconds, s.M = r.months),
        i = new It(s),
    ...
    function Vt(e, t) {
        return function(n, i) {
            var r;
            return null === i || isNaN( + i) || (T(t, "moment()." + t + "(period, number) is deprecated. Please use moment()." + t + "(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."), r = n, n = i, i = r),
    ...
    function Gt(e, t, i, r) {
        ...
        o = Pt(t._days),
        a = Pt(t._months);
        e.isValid() && (r = null == r || r, a && Pe(e, Ee(e, "Month") + a * i), o && Ae(e, "Date", Ee(e, "Date") + o * i), s && e._d.setTime(e._d.valueOf() + s * i), r && n.updateOffset(e, o || a))
    }
    Ft.fn = It.prototype,
    Ft.invalid = function() {
        return Ft(NaN)
    ...
    var Xt = x("moment().lang() is deprecated. Instead, use moment().localeData() to get the language configuration. Use moment().locale() to change languages.",
    function(e) {
    ...
    function tn(e, t, n, i, r) {
        var s;
        return null == e ? qe(this, i, r).year: (t > (s = Fe(e, i, r)) && (t = s),
        function(e, t, n, i, r) {
            var s = We(e, t, n, i, r),
    ...
    }), q(0, ["SSS", 3], 0, "millisecond"), q(0, ["SSSS", 4], 0,
    function() {
    ...
    }), I("millisecond", "ms"), Y("millisecond", 16), le("S", J, B), le("SS", J, V), le("SSS", J, G), sn = "SSSS"; sn.length <= 9; sn += "S") le(sn, ne);
    function an(e, t) {
        t[be] = w(1e3 * ("0." + e))
    }
    ...
    cn.calendar = function(e, t) {
        ...
        return this.format(o || this.localeData().calendar(s, this, Tt(i)))
    },
    cn.clone = function() {
        return new y(this)
    },
    ...
    cn.isAfter = function(e, t) {
        var n = _(e) ? e: Tt(e);
        return ! (!this.isValid() || !n.isValid()) && ("millisecond" === (t = N(s(t) ? "millisecond": t)) ? this.valueOf() > n.valueOf() : n.valueOf() < this.clone().startOf(t).valueOf())
    },
    cn.isBefore = function(e, t) {
        var n = _(e) ? e: Tt(e);
        return ! (!this.isValid() || !n.isValid()) && ("millisecond" === (t = N(s(t) ? "millisecond": t)) ? this.valueOf() < n.valueOf() : this.clone().endOf(t).valueOf() < n.valueOf())
    },
    ...
    cn.set = function(e, t) {
        if ("object" == typeof e) for (var n = function(e) {
            ...
            t
        } (e = P(e)), i = 0; i < n.length; i++) this[n[i].unit](e[n[i].unit]);
    ...
    cn.utcOffset = function(e, t, i) {
        ...
        if (null != e) {
            ...
            return ! this._isUTC && t && (r = $t(this)),
            this._offset = e,
            this._isUTC = !0,
            null != r && this.add(r, "m"),
            s !== e && (!t || this._changeInProgress ? Gt(this, Ft(e - s, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0, n.updateOffset(this, !0), this._changeInProgress = null)),
            this
        }
    ...
    cn.local = function(e) {
        return this._isUTC && (this.utcOffset(0, e), this._isUTC = !1, e && this.subtract($t(this), "m")),
        this
    },
    ...
    cn.dates = x("dates accessor is deprecated. Use date instead.", nn),
    cn.months = x("months accessor is deprecated. Use month instead", Le),
    cn.years = x("years accessor is deprecated. Use year instead", Se),
    cn.zone = x("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/",
    function(e, t) {
        return null != e ? ("string" != typeof e && (e = -e), this.utcOffset(e, t), this) : -this.utcOffset()
    }),
    cn.isDSTShifted = x("isDSTShifted is deprecated. See http://momentjs.com/guides/#/warnings/dst-shifted/ for more information",
    function() {
    ...
    hn.monthsParse = function(e, t, n) {
        ...
        if (this._monthsParseExact) return function(e, t, n) {
            ...
            if (!this._monthsParse) for (this._monthsParse = [], this._longMonthsParse = [], this._shortMonthsParse = [], i = 0; i < 12; ++i) s = h([2e3, i]),
            this._shortMonthsParse[i] = this.monthsShort(s, "").toLocaleLowerCase(),
            this._longMonthsParse[i] = this.months(s, "").toLocaleLowerCase();
            return n ? "MMM" === t ? -1 !== (r = ke.call(this._shortMonthsParse, o)) ? r: null: -1 !== (r = ke.call(this._longMonthsParse, o)) ? r: null: "MMM" === t ? -1 !== (r = ke.call(this._shortMonthsParse, o)) ? r: -1 !== (r = ke.call(this._longMonthsParse, o)) ? r: null: -1 !== (r = ke.call(this._longMonthsParse, o)) ? r: -1 !== (r = ke.call(this._shortMonthsParse, o)) ? r: null
        }.call(this, e, t, n);
    ...
    hn.monthsRegex = function(e) {
        return this._monthsParseExact ? (c(this, "_monthsRegex") || He.call(this), e ? this._monthsStrictRegex: this._monthsRegex) : (c(this, "_monthsRegex") || (this._monthsRegex = je), this._monthsStrictRegex && e ? this._monthsStrictRegex: this._monthsRegex)
    },
    hn.monthsShortRegex = function(e) {
        return this._monthsParseExact ? (c(this, "_monthsRegex") || He.call(this), e ? this._monthsShortStrictRegex: this._monthsShortRegex) : (c(this, "_monthsShortRegex") || (this._monthsShortRegex = Ye), this._monthsShortStrictRegex && e ? this._monthsShortStrictRegex: this._monthsShortRegex)
    },
    hn.week = function(e) {
    ...
    hn.weekdaysParse = function(e, t, n) {
        ...
        if (this._weekdaysParseExact) return function(e, t, n) {
            var i, r, s, o = e.toLocaleLowerCase();
            if (!this._weekdaysParse) for (this._weekdaysParse = [], this._shortWeekdaysParse = [], this._minWeekdaysParse = [], i = 0; i < 7; ++i) s = h([2e3, 1]).day(i),
    ...
    n.lang = x("moment.lang is deprecated. Use moment.locale instead.", at),
    n.langData = x("moment.langData is deprecated. Use moment.localeData instead.", ct);
    var mn = Math.abs;
    function gn(e, t, n, i) {
        var r = Ft(t, n);
    ...
    function Wn() {
        ...
        return d + "P" + (s ? f + s + "Y": "") + (o ? f + o + "M": "") + (a ? p + a + "D": "") + (l || c || u ? "T": "") + (l ? m + l + "H": "") + (c ? m + c + "M": "") + (u ? m + u + "S": "")
    }
    var qn = It.prototype;
    ...
    qn.as = function(e) {
        ...
        if ("month" === (e = N(e)) || "year" === e) return t = this._days + i / 864e5,
        n = this._months + yn(t),
        "month" === e ? n: n / 12;
    ...
    qn._bubble = function() {
        ...
        a = this._months,
        l = this._data;
        return s >= 0 && o >= 0 && a >= 0 || s <= 0 && o <= 0 && a <= 0 || (s += 864e5 * vn(_n(a) + o), o = 0, a = 0),
    ...
    qn.humanize = function(e) {
        if (!this.isValid()) return this.localeData().invalidDate();
        var t, n, i, r, s, o, a, l, c, u, h, d = this.localeData(),
        f = (n = !e, i = d, r = Ft(t = this).abs(), s = jn(r.as("s")), o = jn(r.as("m")), a = jn(r.as("h")), l = jn(r.as("d")), c = jn(r.as("M")), u = jn(r.as("y")), (h = s <= Hn.ss && ["s", s] || s < Hn.s && ["ss", s] || o <= 1 && ["m"] || o < Hn.m && ["mm", o] || a <= 1 && ["h"] || a < Hn.h && ["hh", a] || l <= 1 && ["d"] || l < Hn.d && ["dd", l] || c <= 1 && ["M"] || c < Hn.M && ["MM", c] || u <= 1 && ["y"] || ["yy", u])[2] = n, h[3] = +t > 0, h[4] = i,
        function(e, t, n, i, r) {
    ...
    qn.locale = Zt,
    qn.localeData = Jt,
    qn.toIsoString = x("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", Wn),
    qn.lang = Xt,
    q("X", 0, 0, "unix"),
    q("x", 0, 0, "valueOf"),
    le("x", ie),
        ...
        slimScroll: function(n) {
            ...
            return this.each(function() {
                ...
                if (m.parent().hasClass(i.wrapperClass)) {
                    ...
                    m.bind("touchmove",
                    function(e) { (p || e.originalEvent.preventDefault(), e.originalEvent.touches.length) && (k((l - e.originalEvent.touches[0].pageY) / i.touchScrollStep, !0), l = e.originalEvent.touches[0].pageY)
                    }),
                    S(),
                    "bottom" === i.start ? (D.css({
                        top: m.outerHeight() - D.outerHeight()
                    }), k(0, !0)) : "top" !== i.start && (k(e(i.start).position().top, null, !0), i.alwaysVisible || D.hide()),
                    b = this,
                ...
                function x(t) {
                    if (r) {
                        ...
                        e(s).closest("." + i.wrapperClass).is(m.parent()) && k(n, !0),
                ...
                function k(e, t, n) {
                    ...
                    if (t && (r = parseInt(D.css("top")) + e * parseInt(i.wheelStep) / 100 * D.outerHeight(), r = Math.min(Math.max(r, 0), s), r = e > 0 ? Math.ceil(r) : Math.floor(r), D.css({
                        top: r + "px"
                    })), r = (u = parseInt(D.css("top")) / (m.outerHeight() - D.outerHeight())) * (m[0].scrollHeight - m.outerHeight()), n) {
                        var o = (r = e) / m[0].scrollHeight * m.outerHeight();
                ...
                function E() {
                    i.alwaysVisible || (a = setTimeout(function() {
                        i.disableFadeOut && r || s || o || (D.fadeOut("slow"), w.fadeOut("slow"))
                    },
                    1e3))
                }
            }),
...
function(e, t) {
    var n = function(n, i, r) {
        ...
        if (void 0 === i.startDate && void 0 === i.endDate && t(this.element).is(":text")) {
            ...
            a = l = null,
            2 == h.length ? (a = e(h[0], this.locale.format), l = e(h[1], this.locale.format)) : this.singleDatePicker && "" !== u && (a = e(u, this.locale.format), l = e(u, this.locale.format)),
            null !== a && null !== l && (this.setStartDate(a), this.setEndDate(l))
        }
        if ("object" == typeof i.ranges) {
            for (c in i.ranges) {
                a = "string" == typeof i.ranges[c][0] ? e(i.ranges[c][0], this.locale.format) : e(i.ranges[c][0]),
                l = "string" == typeof i.ranges[c][1] ? e(i.ranges[c][1], this.locale.format) : e(i.ranges[c][1]),
        ...
        this.container.find(".drp-calendar").on("click.daterangepicker", ".prev", t.proxy(this.clickPrev, this)).on("click.daterangepicker", ".next", t.proxy(this.clickNext, this)).on("mousedown.daterangepicker", "td.available", t.proxy(this.clickDate, this)).on("mouseenter.daterangepicker", "td.available", t.proxy(this.hoverDate, this)).on("change.daterangepicker", "select.yearselect", t.proxy(this.monthOrYearChanged, this)).on("change.daterangepicker", "select.monthselect", t.proxy(this.monthOrYearChanged, this)).on("change.daterangepicker", "select.hourselect,select.minuteselect,select.secondselect,select.ampmselect", t.proxy(this.timeChanged, this)),
        this.container.find(".ranges").on("click.daterangepicker", "li", t.proxy(this.clickRange, this)),
        this.container.find(".drp-buttons").on("click.daterangepicker", "button.applyBtn", t.proxy(this.clickApply, this)).on("click.daterangepicker", "button.cancelBtn", t.proxy(this.clickCancel, this)),
        ...
        }) : (this.element.on("click.daterangepicker", t.proxy(this.toggle, this)), this.element.on("keydown.daterangepicker", t.proxy(this.toggle, this))),
        this.updateElement()
    };
    return n.prototype = {
        constructor: n,
        setStartDate: function(t) {
            "string" == typeof t && (this.startDate = e(t, this.locale.format)),
        ...
        setEndDate: function(t) {
            "string" == typeof t && (this.endDate = e(t, this.locale.format)),
        ...
        updateCalendars: function() {
            if (this.timePicker) {
                var e, t, n, i;
                if (this.endDate) {
                    if (e = parseInt(this.container.find(".left .hourselect").val(), 10), t = parseInt(this.container.find(".left .minuteselect").val(), 10), n = this.timePickerSeconds ? parseInt(this.container.find(".left .secondselect").val(), 10) : 0, !this.timePicker24Hour)"PM" === (i = this.container.find(".left .ampmselect").val()) && e < 12 && (e += 12),
                    "AM" === i && 12 === e && (e = 0)
                } else if (e = parseInt(this.container.find(".right .hourselect").val(), 10), t = parseInt(this.container.find(".right .minuteselect").val(), 10), n = this.timePickerSeconds ? parseInt(this.container.find(".right .secondselect").val(), 10) : 0, !this.timePicker24Hour)"PM" === (i = this.container.find(".right .ampmselect").val()) && e < 12 && (e += 12),
                "AM" === i && 12 === e && (e = 0);
                this.leftCalendar.month.hour(e).minute(t).second(n),
                this.rightCalendar.month.hour(e).minute(t).second(n)
            }
        ...
        renderCalendar: function(n) {
            var i, r = (i = "left" == n ? this.leftCalendar: this.rightCalendar).month.month(),
            s = i.month.year(),
            o = i.month.hour(),
            a = i.month.minute(),
            l = i.month.second(),
            ...
            p = e([f, d]).daysInMonth(),
            m = u.day(); (i = []).firstDay = u,
            i.lastDay = h;
            for (var g = 0; g < 6; g++) i[g] = [];
            var v = p - m + this.locale.firstDay + 1;
            v > p && (v -= 7),
            m == this.locale.firstDay && (v = p - 6);
            for (var y = e([f, d, v, 12, a, l]), _ = (g = 0, 0), b = 0; g < 42; g++, _++, y = e(y).add(24, "hour")) g > 0 && _ % 7 == 0 && (_ = 0, b++),
            ...
            w && !w.isBefore(i.firstDay) || this.linkedCalendars && "left" != n ? C += "<th></th>": C += '<th class="prev available"><span></span></th>';
            ...
            if (this.showDropdowns) {
                ...
                P = E; P <= T; P++) N += '<option value="' + P + '"' + (P === S ? ' selected="selected"': "") + ">" + P + "</option>";
                x = M + (N += "</select>")
            }
            if (C += '<th colspan="5" class="month">' + x + "</th>", D && !D.isAfter(i.lastDay) || this.linkedCalendars && "right" != n && !this.singleDatePicker ? C += "<th></th>": C += '<th class="next available"><span></span></th>', C += "</tr>", C += "<tr>", (this.showWeekNumbers || this.showISOWeekNumbers) && (C += '<th class="week">' + this.locale.weekLabel + "</th>"), t.each(this.locale.daysOfWeek,
            function(e, t) {
                C += "<th>" + t + "</th>"
            ...
            for (b = 0; b < 6; b++) {
                C += "<tr>",
                this.showWeekNumbers ? C += '<td class="week">' + i[b][0].week() + "</td>": this.showISOWeekNumbers && (C += '<td class="week">' + i[b][0].isoWeek() + "</td>");
                for (_ = 0; _ < 7; _++) {
                    var Y = [];
                    i[b][_].isSame(new Date, "day") && Y.push("today"),
                    i[b][_].isoWeekday() > 5 && Y.push("weekend"),
                    i[b][_].month() != i[1][1].month() && Y.push("off"),
                    this.minDate && i[b][_].isBefore(this.minDate, "day") && Y.push("off", "disabled"),
                    D && i[b][_].isAfter(D, "day") && Y.push("off", "disabled"),
                    this.isInvalidDate(i[b][_]) && Y.push("off", "disabled"),
                    i[b][_].format("YYYY-MM-DD") == this.startDate.format("YYYY-MM-DD") && Y.push("active", "start-date"),
                    null != this.endDate && i[b][_].format("YYYY-MM-DD") == this.endDate.format("YYYY-MM-DD") && Y.push("active", "end-date"),
                    null != this.endDate && i[b][_] > this.startDate && i[b][_] < this.endDate && Y.push("in-range");
                    var j = this.isCustomDate(i[b][_]); ! 1 !== j && ("string" == typeof j ? Y.push(j) : Array.prototype.push.apply(Y, j));
                    var H = "",
                    $ = !1;
                    for (g = 0; g < Y.length; g++) H += Y[g] + " ",
                    "disabled" == Y[g] && ($ = !0);
                    $ || (H += "available"),
                    C += '<td class="' + H.replace(/^\s+|\s+$/g, "") + '" data-title="r' + b + "c" + _ + '">' + i[b][_].date() + "</td>"
                }
                C += "</tr>"
            }
            C += "</tbody>",
            C += "</table>",
            this.container.find(".drp-calendar." + n + " .calendar-table").html(C)
        },
        renderTimePicker: function(e) {
            if ("right" != e || this.endDate) {
                var t, n, i, r = this.maxDate;
                if (!this.maxSpan || this.maxDate && !this.startDate.clone().add(this.maxSpan).isAfter(this.maxDate) || (r = this.startDate.clone().add(this.maxSpan)), "left" == e) n = this.startDate.clone(),
                i = this.minDate;
                else if ("right" == e) {
                    n = this.endDate.clone(),
                    i = this.startDate;
                    var s = this.container.find(".drp-calendar.right .calendar-time");
                    if ("" != s.html() && (n.hour(n.hour() || s.find(".hourselect option:selected").val()), n.minute(n.minute() || s.find(".minuteselect option:selected").val()), n.second(n.second() || s.find(".secondselect option:selected").val()), !this.timePicker24Hour)) {
                ...
                for (var a = this.timePicker24Hour ? 0 : 1, l = this.timePicker24Hour ? 23 : 12, c = a; c <= l; c++) {
                    ...
                    u != n.hour() || d ? t += d ? '<option value="' + c + '" disabled="disabled" class="disabled">' + c + "</option>": '<option value="' + c + '">' + c + "</option>": t += '<option value="' + c + '" selected="selected">' + c + "</option>"
                }
                t += "</select> ",
                ...
                for (c = 0; c < 60; c += this.timePickerIncrement) {
                    ...
                    n.minute() != c || d ? t += d ? '<option value="' + c + '" disabled="disabled" class="disabled">' + f + "</option>": '<option value="' + c + '">' + f + "</option>": t += '<option value="' + c + '" selected="selected">' + f + "</option>"
                }
                if (t += "</select> ", this.timePickerSeconds) {
                    ...
                    for (c = 0; c < 60; c++) {
                        ...
                        i && h.isBefore(i) && (d = !0),
                        r && h.isAfter(r) && (d = !0),
                        n.second() != c || d ? t += d ? '<option value="' + c + '" disabled="disabled" class="disabled">' + f + "</option>": '<option value="' + c + '">' + f + "</option>": t += '<option value="' + c + '" selected="selected">' + f + "</option>"
                    }
                    t += "</select> "
                }
                if (!this.timePicker24Hour) {
                    ...
                    r && n.clone().hour(0).minute(0).second(0).isAfter(r) && (m = ' disabled="disabled" class="disabled"'),
                    n.hour() >= 12 ? t += '<option value="AM"' + p + '>AM</option><option value="PM" selected="selected"' + m + ">PM</option>": t += '<option value="AM" selected="selected"' + p + '>AM</option><option value="PM"' + m + ">PM</option>",
                    t += "</select>"
                }
        ...
        move: function() {
            ...
            e = "up" == this.drops ? this.element.offset().top - this.container.outerHeight() - n.top: this.element.offset().top + this.element.outerHeight() - n.top,
        ...
        clickPrev: function(e) {
            t(e.target).parents(".drp-calendar").hasClass("left") ? (this.leftCalendar.month.subtract(1, "month"), this.linkedCalendars && this.rightCalendar.month.subtract(1, "month")) : this.rightCalendar.month.subtract(1, "month"),
            this.updateCalendars()
        },
        clickNext: function(e) {
            t(e.target).parents(".drp-calendar").hasClass("left") ? this.leftCalendar.month.add(1, "month") : (this.rightCalendar.month.add(1, "month"), this.linkedCalendars && this.leftCalendar.month.add(1, "month")),
            this.updateCalendars()
        },
        hoverDate: function(e) {
            if (t(e.target).hasClass("available")) {
                ...
                i = n.substr(1, 1),
                r = n.substr(3, 1),
                s = t(e.target).parents(".drp-calendar").hasClass("left") ? this.leftCalendar.calendar[i][r] : this.rightCalendar.calendar[i][r],
                o = this.leftCalendar,
                ...
                this.endDate || this.container.find(".drp-calendar tbody td").each(function(e, n) {
                    if (!t(n).hasClass("week")) {
                        ...
                        r = i.substr(1, 1),
                        c = i.substr(3, 1),
                        u = t(n).parents(".drp-calendar").hasClass("left") ? o.calendar[r][c] : a.calendar[r][c];
                        u.isAfter(l) && u.isBefore(s) || u.isSame(s, "day") ? t(n).addClass("in-range") : t(n).removeClass("in-range")
                    }
                })
            }
        },
            ...
            if (t(e.target).hasClass("available")) {
                ...
                if (this.endDate || s.isBefore(this.startDate, "day")) {
                    if (this.timePicker) {
                        ...
                        if (!this.timePicker24Hour)"PM" === (c = this.container.find(".left .ampmselect").val()) && o < 12 && (o += 12),
                        "AM" === c && 12 === o && (o = 0);
                    ...
                    if (this.timePicker) {
                        ...
                        if (!this.timePicker24Hour)"PM" === (c = this.container.find(".right .ampmselect").val()) && o < 12 && (o += 12),
                        "AM" === c && 12 === o && (o = 0);
            ...
            for (var n in this.ranges) {
                if (this.timePicker) {
                    ...
                    if (this.startDate.format(i) == this.ranges[n][0].format(i) && this.endDate.format(i) == this.ranges[n][1].format(i)) {
                        e = !1,
                        this.chosenLabel = this.container.find(".ranges li:eq(" + t + ")").addClass("active").attr("data-range-key");
                        break
                    }
        ...
        monthOrYearChanged: function(e) {
            ...
            n || (o < this.startDate.year() || o == this.startDate.year() && s < this.startDate.month()) && (s = this.startDate.month(), o = this.startDate.year()),
            this.minDate && (o < this.minDate.year() || o == this.minDate.year() && s < this.minDate.month()) && (s = this.minDate.month(), o = this.minDate.year()),
            this.maxDate && (o > this.maxDate.year() || o == this.maxDate.year() && s > this.maxDate.month()) && (s = this.maxDate.month(), o = this.maxDate.year()),
            n ? (this.leftCalendar.month.month(s).year(o), this.linkedCalendars && (this.rightCalendar.month = this.leftCalendar.month.clone().add(1, "month"))) : (this.rightCalendar.month.month(s).year(o), this.linkedCalendars && (this.leftCalendar.month = this.rightCalendar.month.clone().subtract(1, "month"))),
            this.updateCalendars()
        },
        ...
        elementChanged: function() {
            if (this.element.is("input") && this.element.val().length) {
                ...
                n = null,
                i = null;
                2 === t.length && (n = e(t[0], this.locale.format), i = e(t[1], this.locale.format)),
                (this.singleDatePicker || null === n || null === i) && (i = n = e(this.element.val(), this.locale.format)),
        ...
        updateElement: function() {
            if (this.element.is("input") && this.autoUpdateInput) {
                ...
                this.singleDatePicker || (e += this.locale.separator + this.endDate.format(this.locale.format)),
...
function(e) {
    ...
    var n, i, r, s, o, a, l, c, u = function(e) {
        var t = "transitionend",
        n = {
...
default:
    ...
    c = function() {
        ...
        return i.init = function() {
            ...
            n(this.element).find(t.parentTrigger).has(t.subMenu).children(t.triggerElement).on(l.CLICK_DATA_API,
            function(i) {
                var r = n(this),
                s = r.parent(t.parentTrigger),
                o = s.siblings(t.parentTrigger).children(t.triggerElement),
                a = s.children(t.subMenu);
                t.preventDefault && i.preventDefault(),
                "true" !== r.attr("aria-disabled") && (s.hasClass(t.activeClass) ? (r.attr("aria-expanded", !1), e.hide(a)) : (e.show(a), r.attr("aria-expanded", !0), t.toggle && o.attr("aria-expanded", !1)), t.onTransitionStart && t.onTransitionStart(i))
            })
        },
        i.show = function(e) {
            var t = this;
            if (!this.transitioning && !n(e).hasClass(this.config.collapsingClass)) {
                ...
                if (i.trigger(r), !r.isDefaultPrevented()) {
                    ...
                    u.supportsTransitionEnd() ? i.height(e[0].scrollHeight).one(u.TRANSITION_END, s).mmEmulateTransitionEnd(350) : s()
                }
            }
        },
        i.hide = function(e) {
            ...
            if (!this.transitioning && n(e).hasClass(this.config.collapseInClass)) {
                ...
                if (i.trigger(r), !r.isDefaultPrevented()) {
                    ...
                    u.supportsTransitionEnd() ? 0 === i.height() || "none" === i.css("display") ? s() : i.height(0).one(u.TRANSITION_END, s).mmEmulateTransitionEnd(350) : s()
                }
            }
        },
        ...
        e.jQueryInterface = function(i) {
            return this.each(function() {
                ...
                if (!o && /dispose/.test(i) && this.dispose(), o || (o = new e(this, l), s.data(r, o)), "string" == typeof i) {
...
function(e) {
    ...
    var t = function() {
        ...
        function(e) {
            ...
            function s(e, t) {
                var n, i, r, s, o, a, l, c, u, h, d, f = t && t.split("/"),
                p = v.map,
                m = p && p["*"] || {};
                if (e) {
                    for (o = (e = e.split("/")).length - 1, v.nodeIdCompat && w.test(e[o]) && (e[o] = e[o].replace(w, "")), "." === e[0].charAt(0) && f && (e = f.slice(0, f.length - 1).concat(e)), u = 0; u < e.length; u++) if ("." === (d = e[u])) e.splice(u, 1),
                    u -= 1;
                    else if (".." === d) {
            ...
            f = function(e, t) {
                ...
                return e = r[1],
                o && (n = l(o = s(o, a))),
                o ? e = n && n.normalize ? n.normalize(e, (i = a,
                function(e) {
                    return s(e, i)
                })) : s(e, a) : (o = (r = c(e = s(e, a)))[0], e = r[1], o && (n = l(o))),
                {
                    f: o ? o + "!" + e: e,
                    n: e,
                    pr: o,
            ...
            p = {
                ...
                var c, h, d, v, _, b, w, D = [],
                C = typeof r;
                if (b = u(s = s || n), "undefined" === C || "function" === C) {
                    for (i = !i.length && r.length ? ["require", "exports", "module"] : i, _ = 0; _ < i.length; _ += 1) if ("require" === (h = (v = f(i[_], b)).f)) D[_] = p.require(n);
                    else if ("exports" === h) D[_] = p.exports(n),
                    w = !0;
                    else if ("module" === h) c = D[_] = p.module(n);
                    else if (t(m, h) || t(g, h) || t(y, h)) D[_] = l(h);
                    else {
                        if (!v.p) throw new Error(n + " missing " + h);
                        v.p.load(v.n, o(s, !0), a(h), {}),
                        D[_] = m[h]
                    }
                    d = r ? r.apply(m[n], D) : void 0,
                    n && (c && c.exports !== e && c.exports !== m[n] ? m[n] = c.exports: d === e && w || (m[n] = d))
                } else n && (m[n] = r)
            },
            n = i = d = function(t, n, i, r, s) {
                ...
                r ? h(e, t, n, i) : setTimeout(function() {
                    h(e, t, n, i)
                },
                4),
                d
            ...
            (r = function(e, n, i) {
                ...
                n.splice || (i = n, n = []),
                t(m, e) || t(g, e) || (g[e] = [e, n, i])
            }).amd = {
                jQuery: !0
            }
        } (), t.requirejs = n, t.require = i, t.define = r),
        t.define("almond",
        function() {}),
        t.define("jquery", [],
        function() {
        ...
        function(e) {
            ...
            i.prototype.invoke = function(e, t) {
                for (var n = 0,
                i = e.length; n < i; n++) e[n].apply(this, t)
            },
            n.Observable = i,
            n.generateChars = function(e) {
                for (var t = "",
                n = 0; n < e; n++) t += Math.floor(36 * Math.random()).toString(36);
                return t
            },
            n.bind = function(e, t) {
                return function() {
                ...
                for (var t in e) {
                    ...
                    if (1 !== n.length) {
                        for (var r = 0; r < n.length; r++) {
                            var s = n[r]; (s = s.substring(0, 1).toLowerCase() + s.substring(1)) in i || (i[s] = {}),
            ...
            return n.GetUniqueElementId = function(e) {
                ...
                return null == t && (e.id ? (t = e.id, e.setAttribute("data-select2-id", t)) : (e.setAttribute("data-select2-id", ++r), t = r.toString())),
                t
            },
        ...
        t.define("select2/results", ["jquery", "./utils"],
        function(e, t) {
            function n(e, t, i) {
                this.$element = e,
                this.data = i,
            ...
            n.prototype.bind = function(n, i) {
                ...
                e.fn.mousewheel && this.$results.on("mousewheel",
                function(e) {
        ...
        t.define("select2/selection/base", ["jquery", "../utils", "../keys"],
        function(e, t, n) {
            function i(e, t) {
                this.$element = e,
                this.options = t,
            ...
            i.prototype._attachCloseHandler = function(n) {
                e(document.body).on("mousedown.select2." + n.id,
                function(n) {
        ...
        t.define("select2/selection/single", ["jquery", "./base", "../utils", "../keys"],
        function(e, t, n, i) {
            function r() {
        ...
        t.define("select2/selection/multiple", ["jquery", "./base", "../utils"],
        function(e, t, n) {
            function i(e, t) {
        ...
        t.define("select2/selection/placeholder", ["../utils"],
        function(e) {
            function t(e, t, n) {
        ...
        t.define("select2/selection/allowClear", ["jquery", "../keys", "../utils"],
        function(e, t, n) {
            function i() {}
        ...
        t.define("select2/selection/search", ["jquery", "../utils", "../keys"],
        function(e, t, n) {
            function i(e, t, n) {
                e.call(this, t, n)
            }
            ...
            i.prototype.bind = function(e, i, r) {
                ...
                function(e) {
                    if (a && "input" === e.type) s.$selection.off("input.search input.searchcheck");
                    else {
                        var t = e.which;
        ...
        t.define("select2/selection/eventRelay", ["jquery"],
        function(e) {
            function t() {}
            return t.prototype.bind = function(t, n, i) {
                ...
                function(t, n) {
                    if ( - 1 !== e.inArray(t, s)) {
                        ...
                        r.$element.trigger(i),
                        -1 !== e.inArray(t, o) && (n.prevented = i.isDefaultPrevented())
                    }
                })
            },
            t
        }),
        t.define("select2/translation", ["jquery", "require"],
        function(e, t) {
            function n(e) {
                this.dict = e || {}
            }
        ...
        t.define("select2/data/base", ["../utils"],
        function(e) {
            function t(e, n) {
        ...
        t.define("select2/data/select", ["./base", "../utils", "jquery"],
        function(e, t, n) {
            function i(e, t) {
                this.$element = e,
                this.options = t,
        ...
        t.define("select2/data/array", ["./select", "../utils", "jquery"],
        function(e, t, n) {
            function i(e, t) {
                var n = t.get("data") || [];
            ...
            i.prototype.convertToOptions = function(e) {
                ...
                for (var r = this,
                s = this.$element.find("option"), o = s.map(function() {
        ...
        t.define("select2/data/ajax", ["./array", "../utils", "jquery"],
        function(e, t, n) {
            function i(e, t) {
        ...
        t.define("select2/data/tags", ["jquery"],
        function(e) {
            function t(t, n, i) {
                var r = i.get("tags"),
                s = i.get("createTag");
            ...
            return t.prototype.query = function(e, t, n) {
                var i = this;
                this._removeOldTags(),
                null != t.term && null == t.page ? e.call(this, t,
                function e(r, s) {
                    for (var o = r.results,
                    a = 0; a < o.length; a++) {
                        var l = o[a],
        ...
        t.define("select2/data/tokenizer", ["jquery"],
        function(e) {
            function t(e, t, n) {
            ...
            t.prototype.query = function(t, n, i) {
                var r = this;
                n.term = n.term || "";
                var s = this.tokenizer(n, this.options,
                function(t) {
                ...
                s.term !== n.term && (this.$search.length && (this.$search.val(s.term), this.$search.focus()), n.term = s.term),
                t.call(this, n, i)
            },
            t.prototype.tokenizer = function(t, n, i, r) {
                for (var s = i.get("tokenSeparators") || [], o = n.term, a = 0, l = this.createTag ||
                function(e) {
                    return {
                        id: e.term,
                        text: e.term
        ...
        t.define("select2/data/minimumInputLength", [],
        function() {
            function e(e, t, n) {
        ...
        t.define("select2/dropdown", ["jquery", "./utils"],
        function(e, t) {
            function n(e, t) {
                this.$element = e,
                this.options = t,
        ...
        t.define("select2/dropdown/search", ["jquery", "../utils"],
        function(e, t) {
            function n() {}
        ...
        t.define("select2/dropdown/hidePlaceholder", [],
        function() {
            function e(e, t, n, i) {
                this.placeholder = this.normalizePlaceholder(n.get("placeholder")),
                e.call(this, t, n, i)
        ...
        t.define("select2/dropdown/infiniteScroll", ["jquery"],
        function(e) {
            function t(e, t, n, i) {
                this.lastParams = {},
                e.call(this, t, n, i),
            ...
            t.prototype.bind = function(t, n, i) {
                ...
                function() {
                    var t = e.contains(document.documentElement, r.$loadingMore[0]); ! r.loading && t && r.$results.offset().top + r.$results.outerHeight(!1) + 50 >= r.$loadingMore.offset().top + r.$loadingMore.outerHeight(!1) && r.loadMore()
                })
            },
        ...
        t.define("select2/dropdown/attachBody", ["jquery", "../utils"],
        function(e, t) {
            function n(t, n, i) {
            ...
            n.prototype._positionDropdown = function() {
                ...
                d.left -= p.left,
                n || i || (r = "below"),
                h || !u || n ? !u && h && n && (r = "below") : r = "above",
                ("above" == r || n && "below" !== r) && (d.top = o.top - p.top - a),
        ...
        t.define("select2/dropdown/minimumResultsForSearch", [],
        function() {
            function e(e, t, n, i) {
        ...
        t.define("select2/dropdown/selectOnClose", ["../utils"],
        function(e) {
            function t() {}
            return t.prototype.bind = function(e, t, n) {
                var i = this;
        ...
        t.define("select2/dropdown/closeOnSelect", [],
        function() {
            function e() {}
        ...
        function(e, t, n, i, r, s, o, a, l, c, u, h, d, f, p, m, g, v, y, _, b, w, D, C, x, k, S, T, E) {
            function A() {
                this.reset()
            }
            return A.prototype.apply = function(h) {
                if (null == (h = e.extend(!0, {},
                this.defaults, h)).dataAdapter) {
                ...
                if (null == h.selectionAdapter) {
                    if (h.multiple ? h.selectionAdapter = r: h.selectionAdapter = i, null != h.placeholder && (h.selectionAdapter = c.Decorate(h.selectionAdapter, s)), h.allowClear && (h.selectionAdapter = c.Decorate(h.selectionAdapter, o)), h.multiple && (h.selectionAdapter = c.Decorate(h.selectionAdapter, a)), null != h.containerCssClass || null != h.containerCss || null != h.adaptContainerCssClass) {
                ...
                this.defaults = {
                    ...
                    matcher: function n(i, r) {
                        ...
                        if (r.children && r.children.length > 0) {
                            ...
                            r), o = r.children.length - 1; o >= 0; o--) null == n(i, r.children[o]) && s.children.splice(o, 1);
        ...
        t.define("select2/options", ["require", "jquery", "./defaults", "./utils"],
        function(e, t, n, i) {
            function r(t, r) {
        ...
        t.define("select2/core", ["jquery", "./options", "./utils", "./keys"],
        function(e, t, n, i) {
            var r = function(e, i) {
            ...
            r.prototype._registerSelectionEvents = function() {
                ...
                this.selection.on("*",
                function(i, r) { - 1 === e.inArray(i, n) && t.trigger(i, r)
                })
            },
        ...
        t.define("jquery-mousewheel", ["jquery"],
        function(e) {
            return e
        }),
        t.define("jquery.select2", ["jquery", "jquery-mousewheel", "./select2/core", "./select2/defaults", "./select2/utils"],
        function(e, t, n, i, r) {
...
function(e, t, n) {
    ...
    var t = function(t, n, i) {
        var r = {
            ...
            getCaret: function() {
                try {
                    ...
                    o = i.selectionStart;
                    return s && -1 === navigator.appVersion.indexOf("MSIE 10") ? ((e = s.createRange()).moveStart("character", -r.val().length), n = e.text.length) : (o || "0" === o) && (n = o),
                    n
                } catch(e) {}
            },
            setCaret: function(e) {
            ...
            events: function() {
                ...
                }).on(e.jMaskGlobals.useInput ? "input.mask": "keyup.mask", r.behaviour).on("paste.mask drop.mask",
                function() {
                    setTimeout(function() {
                        t.keydown().keyup()
                    },
                ...
                function() {
                    a === r.val() || t.data("changed") || t.trigger("change"),
                    t.data("changed", !1)
                }).on("blur.mask",
                function() {
                    a = r.val()
                }).on("focus.mask",
                function(t) { ! 0 === i.selectOnFocus && e(t.target).select()
                }).on("focusout.mask",
                function() {
            ...
            getRegexMask: function() {
                for (var e, t, i, r, s = [], a = 0; a < n.length; a++)(e = o.translation[n.charAt(a)]) ? (t = e.pattern.toString().replace(/.{1}$|^.{1}/g, ""), i = e.optional, (e = e.recursive) ? (s.push(n.charAt(a)), r = {
                    digit: n.charAt(a),
                    pattern: t
            ...
            calculateCaretPosition: function() {
                ...
                i = r.getCaret();
                if (e !== n) {
                    var s, o = t.data("mask-previus-caret-pos") || 0,
                    a = (n = n.length, e.length),
                    l = e = 0,
                    c = 0,
                    u = 0;
                    for (s = i; s < n && r.maskDigitPosMap[s]; s++) l++;
                    for (s = i - 1; 0 <= s && r.maskDigitPosMap[s]; s--) e++;
                    for (s = i - 1; 0 <= s; s--) r.maskDigitPosMap[s] && c++;
                    for (s = o - 1; 0 <= s; s--) r.maskDigitPosMapOld[s] && u++;
                    i > a ? i = 10 * n: o >= i && o !== a ? r.maskDigitPosMapOld[i] || (o = i, i = i - (u - c) - e, r.maskDigitPosMap[i] && (i = o)) : i > o && (i = i + (c - u) + l)
                }
                return i
            },
            ...
            getMasked: function(e, t) {
                ...
                for (i.reverse ? (g = "unshift", m = -1, s = 0, h = d - 1, f = p - 1, a = function() {
                    ...
                    w = u.charAt(f),
                    D = o.translation[b];
                    D ? (w.match(D.pattern) ? (c[g](w), D.recursive && ( - 1 === v ? v = h: h === s && h !== v && (h = v - m), s === v && (h -= m)), h += m) : w === l ? (y--, l = void 0) : D.optional ? (h += m, f -= m) : D.fallback ? (c[g](D.fallback), h += m, f -= m) : r.invalid.push({
                        p: f,
                        v: w,
                        e: D.pattern
            ...
            mapMaskdigitPositions: function(e, t, n) {
                for (e = i.reverse ? e.length - n: 0, r.maskDigitPosMap = {},
                n = 0; n < t.length; n++) r.maskDigitPosMap[t[n] + e] = 1
            },
            callbacks: function(e) {
                ...
                c("onInvalid", 0 < r.invalid.length, [s, e, t, r.invalid, i])
            }
        };
        t = e(t);
        var s, o = this,
        ...
        o.remove = function() {
            var e = r.getCaret();
            return o.options.placeholder && t.removeAttr("placeholder"),
        ...
        o.init = function(a) {
            if (a = a || !1, i = i || {},
            o.clearIfNotMatch = e.jMaskGlobals.clearIfNotMatch, o.byPassKeys = e.jMaskGlobals.byPassKeys, o.translation = e.extend({},
            e.jMaskGlobals.translation, i.translation), o = e.extend(!0, {},
            o, i), s = r.getRegexMask(), a) r.events(),
            r.val(r.getMasked());
            else {
    ...
    var n = function() {
        ...
        r = {},
        s = n.attr("data-mask");
        if (n.attr("data-mask-reverse") && (r.reverse = !0), n.attr("data-mask-clearifnotmatch") && (r.clearIfNotMatch = !0), "true" === n.attr("data-mask-selectonfocus") && (r.selectOnFocus = !0), i(n, s, r)) return n.data("mask", new t(this, s, r))
    },
    i = function(t, n, i) {
        i = i || {};
        var r = e(t).data("mask"),
        ...
        try {
            ...
            "object" != typeof r || s(r.options) !== s(i) || r.mask !== n
        } catch(e) {}
    },
    r = function(e) {
        var t, n = document.createElement("div");
        return (t = (e = "on" + e) in n) || (n.setAttribute(e, "return;"), t = "function" == typeof n[e]),
        t
    };
    e.fn.mask = function(n, r) {
        ...
        s && "" !== s && a && (clearInterval(e.maskWatchers[s]), e.maskWatchers[s] = setInterval(function() {
    ...
    e.applyDataMask = function(t) { ((t = t || e.jMaskGlobals.maskElements) instanceof e ? t: e(t)).filter(e.jMaskGlobals.dataMaskAttr).each(n)
    },
    r = {
    ...
    (r = e.jMaskGlobals = e.extend(!0, {},
    r, e.jMaskGlobals)).dataMask && e.applyDataMask(),
    ...
    e.fn.niceSelect = function(t) {
        function n(t) {
            ...
            i.each(function(t) {
                var i = e(this),
                r = i.data("display");
                n.find("ul").append(e("<li></li>").attr("data-value", i.val()).attr("data-display", r || null).addClass("option" + (i.is(":selected") ? " selected": "") + (i.is(":disabled") ? " disabled": "")).html(i.text()))
            })
        }
        if ("string" == typeof t) return "update" == t ? this.each(function() {
            ...
            r = i.hasClass("open");
            i.length && (i.remove(), n(t), r && t.next().trigger("click"))
        ...
        function(t) {
            ...
            n.toggleClass("open"),
            n.hasClass("open") ? (n.find(".option"), n.find(".focus").removeClass("focus"), n.find(".selected").addClass("focus")) : n.focus()
        }),
        ...
        function(t) {
            ...
            if (32 == t.keyCode || 13 == t.keyCode) return n.hasClass("open") ? i.trigger("click") : n.trigger("click"),
            !1;
            if (40 == t.keyCode) {
                if (n.hasClass("open")) {
